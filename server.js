...
(function(exports) {
  ...
  var upsertMonthlyStatistic = function (_27) {
      return SQL.insert(App_Model_Statistic.monthlyStatisticsTable)(App_Model_StrMap.fromArray([ Data_Tuple.Tuple.create("month")(Prelude.show(Prelude.showInt)(_27.value0.month)), Data_Tuple.Tuple.create("computername")(_27.value0.computername), Data_Tuple.Tuple.create("pictures")(Prelude.show(Prelude.showInt)(_27.value0.pictures)), Data_Tuple.Tuple.create("prints")(Prelude.show(Prelude.showInt)(_27.value0.prints)) ]))(true)("");
  };
  var upsertEventStatistic = function (_26) {
      return SQL.insert(App_Model_Statistic.eventStatisticsTable)(App_Model_StrMap.fromArray([ Data_Tuple.Tuple.create("eventId")(Prelude.show(Prelude.showInt)(_26.value0.eventId)), Data_Tuple.Tuple.create("computername")(_26.value0.computername), Data_Tuple.Tuple.create("pictures")(Prelude.show(Prelude.showInt)(_26.value0.pictures)), Data_Tuple.Tuple.create("prints")(Prelude.show(Prelude.showInt)(_26.value0.prints)) ]))(true)("");
  };
  var unpack = function (_30) {
      return _30;
  };
  ...
  var queryNewFiles = function (conn) {
      return function (cname) {
          return function (d) {
              var q = Database_AnyDB.Query("Select * from FILES i " + ("Join Events e on e.id = i.eventid " + ("where e.computername = ? " + "and i.updatedon > ? ")));
  ...
  var insertPB = function (_17) {
      return SQL.insert(App_Model_Photobooth.photoboothsTable)(App_Model_StrMap.fromArray([ new Data_Tuple.Tuple("computername", _17.value0.computername), new Data_Tuple.Tuple("alias", _17.value0.alias), new Data_Tuple.Tuple("defaultprofile", _17.value0.defaultprofile) ]))(false)("");
  };
  var insertEvent = function (_20) {
      return SQL.insert(App_Model_Event.eventsTable)(App_Model_StrMap.fromArray([ new Data_Tuple.Tuple("computername", _20.value0.computername), new Data_Tuple.Tuple("name", _20.value0.name), Data_Tuple.Tuple.create("datefrom")(App_Model_Date.iso8601(_20.value0.datefrom)), Data_Tuple.Tuple.create("dateuntil")(App_Model_Date.iso8601(_20.value0.dateuntil)), Data_Tuple.Tuple.create("profile")(_20.value0.profile) ]))(false)("");
  };
      ...
      return function (dateNow) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(insertPB(mybooth))(conn))(function () {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(insertPB(yourbooth))(conn))(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(insertEvent(myevent(dateNow)))(conn))(function () {
  ...
  var eventsByCname = function (_15) {
      var _50 = Data_StrMap.lookup("cname")(_15.params);
      ...
      if (_50 instanceof Data_Maybe.Just) {
          var q = SQL.selectStar(App_Model_Event.eventsTable)(" WHERE computername = '" + (_50.value0 + "'"));
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query_(App_Model_Event.partialEventIsForeign)(q)(conn))(function (_1) {
                  var ids = Prelude["<$>"](Prelude.functorArray)(function (_12) {
                      return Data_Maybe.fromMaybe(0)(_12.value0.id);
                  })(_1);
                  return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                      var _55 = Data_Array.length(ids) > 0;
                      if (_55) {
                      ...
                      throw new Error("Failed pattern match at App.DB line 119, column 1 - line 120, column 1: " + [ _55.constructor.name ]);
                  })())(function (_0) {
                      var createEvent = function (_32) {
                          return App_Model_Event.mkEvent(_32)(Data_Array.filter(function (_13) {
                              return _13.value0.eventId === Data_Maybe.fromMaybe(0)(_32.value0.id);
                          })(_0));
                      };
      ...
      throw new Error("Failed pattern match at App.DB line 119, column 1 - line 120, column 1: " + [ _50.constructor.name ]);
  };
  var getFileById = function (_31) {
      var _65 = Data_StrMap.lookup("id")(_31.params);
      if (_65 instanceof Data_Maybe.Nothing) {
          return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("getFileById: No id provided!"));
      };
      if (_65 instanceof Data_Maybe.Just) {
          return Database_AnyDB.withConnection(connectionInfo)(function (c) {
              return Prelude[">>="](Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne(foreignBufferForHttp)("select file from files where id = ?")([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(_65.value0) ])(c))(function (mf) {
      ...
      throw new Error("Failed pattern match at App.DB line 312, column 1 - line 313, column 1: " + [ _65.constructor.name ]);
  };
  var newEvent = function (_19) {
      return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(insertEvent(_19.body))(conn))(function () {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Event.partialEventIsForeign)(SQL.selectLastInserted(App_Model_Event.eventsTable))(conn))(function (_3) {
                  ...
                  throw new Error("Failed pattern match at App.DB line 154, column 1 - line 155, column 1: " + [ _3.constructor.name ]);
              });
          });
      });
  };
  var newPB = function (_16) {
      return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(insertPB(_16.body))(conn))(function () {
  ...
  var saveFileToDb = function (_25) {
      var _83 = Data_StrMap.lookup("eventid")(_25.params);
      if (_83 instanceof Data_Maybe.Nothing) {
          return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("SaveFileToDb: No eventid provided"));
      };
      if (_83 instanceof Data_Maybe.Just) {
          var _84 = safeParseInt(_83.value0);
          if (_84 instanceof Data_Maybe.Nothing) {
              return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("SaveFileToDb: Failed to parse: " + _83.value0));
          };
          if (_84 instanceof Data_Maybe.Just) {
              var _85 = Data_StrMap.lookup("name")(_25.params);
              if (_85 instanceof Data_Maybe.Nothing) {
                  return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("SaveFileToDb: No name provided"));
              };
              if (_85 instanceof Data_Maybe.Just) {
                  return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
                      ...
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute(query)([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(_85.value0), Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueInt)(_84.value0), Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueBuffer)(_25.body) ])(conn))(function () {
              ...
              throw new Error("Failed pattern match at App.DB line 219, column 1 - line 220, column 1: " + [ _85.constructor.name ]);
          };
          throw new Error("Failed pattern match at App.DB line 219, column 1 - line 220, column 1: " + [ _84.constructor.name ]);
      };
      throw new Error("Failed pattern match at App.DB line 219, column 1 - line 220, column 1: " + [ _83.constructor.name ]);
  };
  var updateEvent = function (_23) {
      if (_23.body.value0.id instanceof Data_Maybe.Nothing) {
      ...
      if (_23.body.value0.id instanceof Data_Maybe.Just) {
          var query = SQL.update(App_Model_Event.eventsTable)(_23.body.value0.id.value0)(App_Model_StrMap.fromArray([ new Data_Tuple.Tuple("computername", _23.body.value0.computername), new Data_Tuple.Tuple("name", _23.body.value0.name), Data_Tuple.Tuple.create("datefrom")(App_Model_Date.iso8601(_23.body.value0.datefrom)), Data_Tuple.Tuple.create("dateuntil")(App_Model_Date.iso8601(_23.body.value0.dateuntil)), new Data_Tuple.Tuple("profile", _23.body.value0.profile) ]))("");
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(query)(conn))(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Event.partialEventIsForeign)(SQL.selectStarId(App_Model_Event.eventsTable)(_23.body.value0.id.value0))(conn))(function (_5) {
                      ...
                      throw new Error("Failed pattern match at App.DB line 193, column 1 - line 194, column 1: " + [ _5.constructor.name ]);
                  });
              });
          });
      };
      throw new Error("Failed pattern match at App.DB line 193, column 1 - line 194, column 1: " + [ _23.constructor.name ]);
  };
  var updatePB = function (_22) {
      if (_22.body.value0.id instanceof Data_Maybe.Nothing) {
      ...
      if (_22.body.value0.id instanceof Data_Maybe.Just) {
          var query = SQL.update(App_Model_Photobooth.photoboothsTable)(_22.body.value0.id.value0)(App_Model_StrMap.fromArray([ new Data_Tuple.Tuple("alias", _22.body.value0.alias), new Data_Tuple.Tuple("defaultprofile", _22.body.value0.defaultprofile) ]))("");
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(query)(conn))(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Photobooth.photoboothIsForeign)(SQL.selectStarId(App_Model_Photobooth.photoboothsTable)(_22.body.value0.id.value0))(conn))(function (_4) {
      ...
      throw new Error("Failed pattern match at App.DB line 183, column 1 - line 184, column 1: " + [ _22.constructor.name ]);
  };
  var allStatistics = function (_28) {
      var _121 = Data_StrMap.lookup("cname")(_28.params);
      if (_121 instanceof Data_Maybe.Nothing) {
      ...
      if (_121 instanceof Data_Maybe.Just) {
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query(App_Model_Statistic.eventStatisticIsForeign)("select * from eventstatistics where computername = ?")([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(_121.value0) ])(conn))(function (_8) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query(App_Model_Statistic.monthlyStatisticIsForeign)("select * from monthlystatistics where computername = ?")([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(_121.value0) ])(conn))(function (_7) {
      ...
      throw new Error("Failed pattern match at App.DB line 258, column 1 - line 259, column 1: " + [ _121.constructor.name ]);
  };
  var allPhotobooths = function (_14) {
      return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
  ...
  var addStatistics = function (c) {
      return function (_29) {
          ...
          })(_29.value0.monthlyStatistics))(function (_10) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(function (s) {
                  return Database_AnyDB.execute_(upsertEventStatistic(s))(c);
              })(_29.value0.eventStatistics))(function (_9) {
...
(function(exports) {
  ...
  var readCnamePname = function (__dict_MonadError_0) {
      return function (s) {
          return function (f) {
              return function (_7) {
                  var _11 = Data_StrMap.lookup("cname")(_7.params);
                  ...
                  if (_11 instanceof Data_Maybe.Just) {
                      var _12 = Data_StrMap.lookup("pname")(_7.params);
                      ...
                      if (_12 instanceof Data_Maybe.Just) {
                          return f(_11.value0)(_12.value0);
                      };
                      throw new Error("Failed pattern match at Main line 90, column 1 - line 91, column 1: " + [ _12.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main line 90, column 1 - line 91, column 1: " + [ _11.constructor.name ]);
              };
          };
      };
  };
  var readCnameDate = function (s) {
      return function (f) {
          return function (_6) {
              var _19 = Data_StrMap.lookup("cname")(_6.params);
              ...
              if (_19 instanceof Data_Maybe.Just) {
                  var _20 = Data_StrMap.lookup("date")(_6.params);
                  ...
                  if (_20 instanceof Data_Maybe.Just) {
                      var _21 = Data_Date.fromStringStrict(_20.value0);
                      if (_21 instanceof Data_Maybe.Nothing) {
                      ...
                      if (_21 instanceof Data_Maybe.Just) {
                          return Database_AnyDB.withConnection(App_DB.connectionInfo)(function (c) {
                              return f(c)(_19.value0)(_21.value0);
                          });
                      };
                      throw new Error("Failed pattern match at Main line 79, column 1 - line 80, column 1: " + [ _21.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main line 79, column 1 - line 80, column 1: " + [ _20.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main line 79, column 1 - line 80, column 1: " + [ _19.constructor.name ]);
          };
      };
  };
  var readCname = function (s) {
      return function (f) {
          return function (_5) {
              var _29 = Data_StrMap.lookup("cname")(_5.params);
              if (_29 instanceof Data_Maybe.Nothing) {
                  return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error(s + ": No computername provided"));
              };
              if (_29 instanceof Data_Maybe.Just) {
                  return Database_AnyDB.withConnection(App_DB.connectionInfo)(function (c) {
                      return f(c)(_29.value0);
                  });
              };
              throw new Error("Failed pattern match at Main line 73, column 1 - line 74, column 1: " + [ _29.constructor.name ]);
          };
      };
  };
  var port = 8080;
  ...
  var allProfiles = (function () {
      ...
      return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.readdir(prof))(function (_3) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Prelude.flip(Data_Array.filterM(Control_Monad_Aff.monadAff))(_3)(function (path) {
              return Prelude[">>="](Control_Monad_Aff.bindAff)(Node_FS_Aff.stat(Node_Path.concat([ prof, path ])))(function (_38) {
                  return Prelude["return"](Control_Monad_Aff.applicativeAff)(Node_FS_Stats.isDirectory(_38));
              });
          }))(function (_2) {
              return Prelude.flip(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff))(_2)(function (dir) {
  ...
  var main = function __do() {
      ...
      Control_Monad_Aff.runAff(function (_39) {
          return Control_Monad_Eff_Console.log(Prelude.show(Control_Monad_Eff_Exception.showError)(_39));
      })(Prelude["const"](Control_Monad_Eff_Console.log("Initial SQL OK")))(Database_AnyDB.withConnection(App_DB.connectionInfo)(function (conn) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(App_DB.dropDB(conn))(function () {
              return Prelude.bind(Control_Monad_Aff.bindAff)(App_DB.makeDB(conn))(function () {
                  return App_DB.loadWithDummy(conn)(_1);
              });
          });
      }))();
      var _0 = Server_Core.makeApp();
      Server_Core.hostEndpoint(Data_Generic.genericUnit)(Data_Generic.genericMaybe(App_Model_Photobooth.genericPhotobooth))(_0)(App_Endpoint.getPhotobooth)(readCname("GetPhotobooth")(App_DB.queryPhotobooth))();
      Server_Core.hostEndpoint(Data_Generic.genericUnit)(Data_Generic.genericArray(App_Model_Photobooth.genericPhotobooth))(_0)(App_Endpoint.getPhotobooths)(App_DB.allPhotobooths)();
      Server_Core.hostEndpoint(App_Model_Photobooth.genericPhotobooth)(App_Model_Photobooth.genericPhotobooth)(_0)(App_Endpoint.postPhotobooths)(App_DB.newPB)();
      Server_Core.hostEndpoint(App_Model_Photobooth.genericPhotobooth)(App_Model_Photobooth.genericPhotobooth)(_0)(App_Endpoint.putPhotobooths)(App_DB.updatePB)();
      Server_Core.hostEndpoint(Data_Generic.genericUnit)(Data_Generic.genericArray(App_Model_Event.genericEvent))(_0)(App_Endpoint.getEvents)(App_DB.eventsByCname)();
      Server_Core.hostEndpoint(App_Model_Event.genericEvent)(App_Model_Event.genericEvent)(_0)(App_Endpoint.postEvents)(App_DB.newEvent)();
      Server_Core.hostEndpoint(App_Model_Event.genericEvent)(App_Model_Event.genericEvent)(_0)(App_Endpoint.putEvents)(App_DB.updateEvent)();
      Server_Core.hostEndpoint(Data_Generic.genericUnit)(Data_Generic.genericArray(App_Model_Event.genericPartialEvent))(_0)(App_Endpoint.getNewEvents)(readCnameDate("GetNewEvents")(App_DB.queryNewEvents))();
      ...
      Server_Core.hostEndpoint(Data_Generic.genericUnit)(App_Model_Statistic.genericAllStatistics)(_0)(App_Endpoint.getStatistics)(App_DB.allStatistics)();
      Server_Core.hostEndpoint(Data_Generic.genericUnit)(Data_Generic.genericArray(App_Model_SavedFile.genericSavedFile))(_0)(App_Endpoint.getNewFiles)(readCnameDate("GetNewFiles")(App_DB.queryNewFiles))();
      Server_Core.hostEndpoint(App_Model_Statistic.genericAllStatistics)(Data_Generic.genericUnit)(_0)(App_Endpoint.postStatistics)(function (_4) {
          return Database_AnyDB.withConnection(App_DB.connectionInfo)(function (c) {
              return App_DB.addStatistics(c)(_4.body);
          });
      })();
      ...
      Server_Core.hostFileUploadEndpoint(App_Model_SavedFile.genericSavedFile)(_0)(App_Endpoint.attachFile)(App_DB.saveFileToDb)();
      Server_Core.hostFile(_0)("/api/files/:id")(App_DB.getFileById)();
