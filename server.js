...
(function(exports) {
  ...
  var eventsByCname = function (_15) {
      var _59 = Data_StrMap.lookup("cname")(_15.params);
      ...
      if (_59 instanceof Data_Maybe.Just) {
          var q = SQL.selectStar(App_Model_Event.eventsTable)(" WHERE computername = '" + (_59.value0 + "'"));
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query_(App_Model_Event.partialEventIsForeign)(q)(conn))(function (_1) {
                  ...
                  return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                      var _64 = Data_Array.length(ids) > 0;
                      if (_64) {
                      ...
                      throw new Error("Failed pattern match at App.DB line 121, column 1 - line 122, column 1: " + [ _64.constructor.name ]);
                  })())(function (_0) {
                      var createEvent = function (_33) {
                          return App_Model_Event.mkEvent(_33)(Data_Array.filter(function (_13) {
                              return _13.value0.eventId === Data_Maybe.fromMaybe(0)(_33.value0.id);
                          })(_0));
                      };
      ...
      throw new Error("Failed pattern match at App.DB line 121, column 1 - line 122, column 1: " + [ _59.constructor.name ]);
  };
  var getFileById = function (_31) {
      var _74 = Data_StrMap.lookup("id")(_31.params);
      ...
      if (_74 instanceof Data_Maybe.Just) {
          return Database_AnyDB.withConnection(connectionInfo)(function (c) {
              return Prelude[">>="](Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne(foreignBufferForHttp)("select file from files where id = ?")([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(_74.value0) ])(c))(function (mf) {
      ...
      throw new Error("Failed pattern match at App.DB line 316, column 1 - line 317, column 1: " + [ _74.constructor.name ]);
  };
      ...
      return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(insertEvent(_19.body))(conn))(function () {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Event.partialEventIsForeign)(SQL.selectLastInserted(App_Model_Event.eventsTable))(conn))(function (_3) {
                  ...
                  throw new Error("Failed pattern match at App.DB line 156, column 1 - line 157, column 1: " + [ _3.constructor.name ]);
              });
          });
      });
  };
  ...
  var saveFileToDb = function (_25) {
      var _92 = Data_StrMap.lookup("eventid")(_25.params);
      ...
      if (_92 instanceof Data_Maybe.Just) {
          var _93 = safeParseInt(_92.value0);
          if (_93 instanceof Data_Maybe.Nothing) {
              return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("SaveFileToDb: Failed to parse: " + _92.value0));
          };
          if (_93 instanceof Data_Maybe.Just) {
              var _94 = Data_StrMap.lookup("name")(_25.params);
              ...
              if (_94 instanceof Data_Maybe.Just) {
                  return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
                      ...
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute(query)([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(_94.value0), Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueInt)(_93.value0), Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueBuffer)(_25.body) ])(conn))(function () {
              ...
              throw new Error("Failed pattern match at App.DB line 220, column 1 - line 221, column 1: " + [ _94.constructor.name ]);
          };
          throw new Error("Failed pattern match at App.DB line 220, column 1 - line 221, column 1: " + [ _93.constructor.name ]);
      };
      throw new Error("Failed pattern match at App.DB line 220, column 1 - line 221, column 1: " + [ _92.constructor.name ]);
  };
          ...
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(query)(conn))(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Event.partialEventIsForeign)(SQL.selectStarId(App_Model_Event.eventsTable)(_23.body.value0.id.value0))(conn))(function (_5) {
                      ...
                      throw new Error("Failed pattern match at App.DB line 195, column 1 - line 196, column 1: " + [ _5.constructor.name ]);
                  });
              });
          });
      };
      throw new Error("Failed pattern match at App.DB line 195, column 1 - line 196, column 1: " + [ _23.constructor.name ]);
  };
  var updatePB = function (_22) {
      ...
      throw new Error("Failed pattern match at App.DB line 185, column 1 - line 186, column 1: " + [ _22.constructor.name ]);
  };
  var allStatistics = function (_28) {
      var _130 = Data_StrMap.lookup("cname")(_28.params);
      ...
      if (_130 instanceof Data_Maybe.Just) {
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return queryAllStatistics(conn)(_130.value0);
          });
      };
      throw new Error("Failed pattern match at App.DB line 259, column 1 - line 260, column 1: " + [ _130.constructor.name ]);
  };
