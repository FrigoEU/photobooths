...
(function(exports) {
  ...
  var monthlyStatisticsTable = {
      ...
      columns: App_Model_StrMap.fromArray([ Data_Tuple.Tuple.create("photoboothId")(new SQL.ColumnDef(SQL.Integer.value, [  ])), Data_Tuple.Tuple.create("month")(new SQL.ColumnDef(SQL.Integer.value, [  ])), Data_Tuple.Tuple.create("pictures")(new SQL.ColumnDef(SQL.Integer.value, [  ])), Data_Tuple.Tuple.create("prints")(new SQL.ColumnDef(SQL.Integer.value, [  ])) ])
  };                                                                                   
  var eventStatisticsTable = {
      name: "EVENTSTATISTICS", 
      columns: App_Model_StrMap.fromArray([ Data_Tuple.Tuple.create("photoboothId")(new SQL.ColumnDef(SQL.Integer.value, [  ])), Data_Tuple.Tuple.create("eventId")(new SQL.ColumnDef(SQL.Integer.value, [  ])), Data_Tuple.Tuple.create("pictures")(new SQL.ColumnDef(SQL.Integer.value, [  ])), Data_Tuple.Tuple.create("prints")(new SQL.ColumnDef(SQL.Integer.value, [  ])) ])
  };                                                                             
  var createMonthlyStatisticsTable = "CREATE TABLE MONTHLYSTATISTICS (photoboothId INTEGER, month INTEGER, pictures INTEGER, prints INTEGER, PRIMARY KEY (photoboothId, month))";
  var createEventStatisticsTable = "CREATE TABLE EVENTSTATISTICS (photoboothId INTEGER, eventId INTEGER, pictures INTEGER, prints INTEGER, PRIMARY KEY (photoboothId, eventId))";
...
(function(exports) {
  ...
  var insertPB = function (_15) {
      return SQL.insert(App_Model_Photobooth.photoboothsTable)(App_Model_StrMap.fromArray([ new Data_Tuple.Tuple("computername", _15.value0.computername), new Data_Tuple.Tuple("alias", _15.value0.alias), new Data_Tuple.Tuple("defaultprofile", _15.value0.defaultprofile) ]))("");
  };
  var insertMonthlyStatistic = function (_22) {
      return SQL.insert(App_Model_Statistic.monthlyStatisticsTable)(App_Model_StrMap.fromArray([ Data_Tuple.Tuple.create("month")(Prelude.show(Prelude.showInt)(_22.value0.month)), Data_Tuple.Tuple.create("photoboothId")(Prelude.show(Prelude.showInt)(_22.value0.photoboothId)), Data_Tuple.Tuple.create("pictures")(Prelude.show(Prelude.showInt)(_22.value0.pictures)), Data_Tuple.Tuple.create("prints")(Prelude.show(Prelude.showInt)(_22.value0.prints)) ]))("");
  };
  var insertEventStatistic = function (_21) {
      return SQL.insert(App_Model_Statistic.eventStatisticsTable)(App_Model_StrMap.fromArray([ Data_Tuple.Tuple.create("eventId")(Prelude.show(Prelude.showInt)(_21.value0.eventId)), Data_Tuple.Tuple.create("photoboothId")(Prelude.show(Prelude.showInt)(_21.value0.photoboothId)), Data_Tuple.Tuple.create("pictures")(Prelude.show(Prelude.showInt)(_21.value0.pictures)), Data_Tuple.Tuple.create("prints")(Prelude.show(Prelude.showInt)(_21.value0.prints)) ]))("");
  };
  var insertEvent = function (_17) {
      return SQL.insert(App_Model_Event.eventsTable)(App_Model_StrMap.fromArray([ new Data_Tuple.Tuple("computername", _17.value0.computername), new Data_Tuple.Tuple("name", _17.value0.name), Data_Tuple.Tuple.create("datefrom")(App_Model_Date.iso8601(_17.value0.datefrom)), Data_Tuple.Tuple.create("dateuntil")(App_Model_Date.iso8601(_17.value0.dateuntil)), Data_Tuple.Tuple.create("profile")(_17.value0.profile) ]))("");
  };
  ...
  var eventsByCname = function (_13) {
      var _37 = Data_StrMap.lookup("cname")(_13.params);
      ...
      if (_37 instanceof Data_Maybe.Just) {
          var q = SQL.selectStar(App_Model_Event.eventsTable)(" WHERE computername = '" + (_37.value0 + "'"));
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query_(App_Model_Event.partialEventIsForeign)(q)(conn))(function (_3) {
                  var ids = Prelude["<$>"](Prelude.functorArray)(function (_9) {
                      ...
                      throw new Error("Failed pattern match at Main line 122, column 19 - line 123, column 15: " + [ _9.constructor.name ]);
                  })(_3);
                  return Prelude.bind(Control_Monad_Aff.bindAff)(selectImagesForEvents(ids)(conn))(function (_2) {
                      var createEvent = function (_23) {
                          if (_23.value0.id instanceof Data_Maybe.Just) {
                              return App_Model_Event.mkEvent(_23)(Data_Array.filter(function (_10) {
                                  return _10.value0.eventId === _23.value0.id.value0;
                              })(_2));
                          };
                          throw new Error("Failed pattern match at Main line 124, column 19 - line 125, column 15: " + [ _23.constructor.name ]);
                      };
      ...
      throw new Error("Failed pattern match at Main line 114, column 1 - line 115, column 1: " + [ _37.constructor.name ]);
  };
      ...
      return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(insertEvent(_16.body))(conn))(function () {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Event.partialEventIsForeign)(SQL.selectLastInserted(App_Model_Event.eventsTable))(conn))(function (_5) {
                  ...
                  throw new Error("Failed pattern match at Main line 141, column 1 - line 142, column 1: " + [ _5.constructor.name ]);
              });
          });
      });
  };
  ...
  var saveImageToDb = function (_20) {
      var _67 = Data_StrMap.lookup("eventid")(_20.params);
      ...
      if (_67 instanceof Data_Maybe.Just) {
          var _68 = safeParseInt(_67.value0);
          if (_68 instanceof Data_Maybe.Nothing) {
              return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("SaveImageToDb: Failed to parse: " + _67.value0));
          };
          if (_68 instanceof Data_Maybe.Just) {
              var _69 = Data_StrMap.lookup("name")(_20.params);
              ...
              if (_69 instanceof Data_Maybe.Just) {
                  return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
                      ...
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute(query)([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(_69.value0), Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueInt)(_68.value0), Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueBuffer)(_20.body) ])(conn))(function () {
              ...
              throw new Error("Failed pattern match at Main line 188, column 1 - line 189, column 1: " + [ _69.constructor.name ]);
          };
          throw new Error("Failed pattern match at Main line 188, column 1 - line 189, column 1: " + [ _68.constructor.name ]);
      };
      throw new Error("Failed pattern match at Main line 188, column 1 - line 189, column 1: " + [ _67.constructor.name ]);
  };
  var updateEvent = function (_19) {
      ...
      if (_19.body.value0.id instanceof Data_Maybe.Just) {
          var query = SQL.update(App_Model_Event.eventsTable)(_19.body.value0.id.value0)(App_Model_StrMap.fromArray([ new Data_Tuple.Tuple("computername", _19.body.value0.computername), new Data_Tuple.Tuple("name", _19.body.value0.name), Data_Tuple.Tuple.create("datefrom")(App_Model_Date.iso8601(_19.body.value0.datefrom)), Data_Tuple.Tuple.create("dateuntil")(App_Model_Date.iso8601(_19.body.value0.dateuntil)), new Data_Tuple.Tuple("profile", _19.body.value0.profile) ]))("");
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(query)(conn))(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Event.partialEventIsForeign)(SQL.selectStarId(App_Model_Event.eventsTable)(_19.body.value0.id.value0))(conn))(function (_7) {
                      ...
                      throw new Error("Failed pattern match at Main line 170, column 1 - line 171, column 1: " + [ _7.constructor.name ]);
                  });
              });
          });
      };
      throw new Error("Failed pattern match at Main line 170, column 1 - line 171, column 1: " + [ _19.constructor.name ]);
  };
  var updatePB = function (_18) {
      ...
      if (_18.body.value0.id instanceof Data_Maybe.Just) {
          var query = SQL.update(App_Model_Photobooth.photoboothsTable)(_18.body.value0.id.value0)(App_Model_StrMap.fromArray([ new Data_Tuple.Tuple("alias", _18.body.value0.alias), new Data_Tuple.Tuple("defaultprofile", _18.body.value0.defaultprofile) ]))("");
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(query)(conn))(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Photobooth.photoboothIsForeign)(SQL.selectStarId(App_Model_Photobooth.photoboothsTable)(_18.body.value0.id.value0))(conn))(function (_6) {
      ...
      throw new Error("Failed pattern match at Main line 160, column 1 - line 161, column 1: " + [ _18.constructor.name ]);
  };
  ...
  var main = function __do() {
      ...
      Control_Monad_Aff.runAff(function (_106) {
          return Control_Monad_Eff_Console.log(Prelude.show(Control_Monad_Eff_Exception.showError)(_106));
