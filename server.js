...
(function(exports) {
  ...
  var Data_Maybe = PS["Data.Maybe"];
  exports["dateToSqlForComparing"] = $foreign.dateToSqlForComparing;
...
(function(exports) {
  ...
  var updatePB = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at App.DB line 214, column 1 - line 216, column 1: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  ...
  var queryNewFiles = function (conn) {
      return function (v) {
          ...
          return Database_AnyDB.query(App_Model_SavedFile.savedFileIsForeign)(q)([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(v.value0), Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(App_Model_Date.dateToSqlForComparing(v.value1)) ])(conn);
      };
  };
  var queryNewEvents = function (conn) {
      return function (v) {
          var q = Database_AnyDB.Query("Select * from EVENTS " + ("where computername = ? " + "and updatedon > ?"));
          return Database_AnyDB.query(App_Model_Event.partialEventIsForeign)(q)([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(v.value0), Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(App_Model_Date.dateToSqlForComparing(v.value1)) ])(conn);
      };
  };
