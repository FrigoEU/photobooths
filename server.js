...
(function(exports) {
  ...
  var getNewImages = new Endpoint_Client.Endpoint({
      method: Network_HTTP_Method.GET.value, 
      serverUrl: "/api/newevents/:cname/:date", 
      mkClientUrl: function (_2) {
          return "api/newevents/" + (_2.value0 + ("/" + App_Model_Date.iso8601(_2.value1)));
      }
  });
  ...
  exports["getNewImages"] = getNewImages;
...
(function(exports) {
  ...
  var hostFileEndpoint = function (__dict_Generic_1) {
      return function (app) {
          return function (_13) {
              return function (f) {
...
(function(exports) {
  ...
  var App_Model_StrMap = PS["App.Model.StrMap"];
  var Data_Generic = PS["Data.Generic"];     
  var yourbooth = new App_Model_Photobooth.Photobooth({
      id: Data_Maybe.Nothing.value, 
      computername: "yourcomputername", 
      alias: "youralias", 
      defaultprofile: "yourprofile"
  });
  var upsertMonthlyStatistic = function (_28) {
      return SQL.insert(App_Model_Statistic.monthlyStatisticsTable)(App_Model_StrMap.fromArray([ Data_Tuple.Tuple.create("month")(Prelude.show(Prelude.showInt)(_28.value0.month)), Data_Tuple.Tuple.create("computername")(_28.value0.computername), Data_Tuple.Tuple.create("pictures")(Prelude.show(Prelude.showInt)(_28.value0.pictures)), Data_Tuple.Tuple.create("prints")(Prelude.show(Prelude.showInt)(_28.value0.prints)) ]))(true)("");
  };
  var upsertEventStatistic = function (_27) {
      return SQL.insert(App_Model_Statistic.eventStatisticsTable)(App_Model_StrMap.fromArray([ Data_Tuple.Tuple.create("eventId")(Prelude.show(Prelude.showInt)(_27.value0.eventId)), Data_Tuple.Tuple.create("computername")(_27.value0.computername), Data_Tuple.Tuple.create("pictures")(Prelude.show(Prelude.showInt)(_27.value0.pictures)), Data_Tuple.Tuple.create("prints")(Prelude.show(Prelude.showInt)(_27.value0.prints)) ]))(true)("");
  };
  var selectImagesForEvents = function (is) {
      return function (conn) {
          var qs = Data_String.joinWith(", ")(Data_Array.replicate(Data_Array.length(is))("?"));
          return Database_AnyDB.query(App_Model_SavedImage.savedImageIsForeign)(SQL.selectStar(App_Model_SavedImage.savedImageTable)("WHERE eventid = (" + (qs + ")")))(Prelude.map(Prelude.functorArray)(Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueInt))(is))(conn);
      };
  };
  var selectImagesForEvent = function (i) {
      return function (conn) {
          return Database_AnyDB.query(App_Model_SavedImage.savedImageIsForeign)(SQL.selectStar(App_Model_SavedImage.savedImageTable)("WHERE eventid = ?"))([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueInt)(i) ])(conn);
      };
  };
  var safeParseInt = function (str) {
      return $foreign.pInt(Data_Maybe.Nothing.value)(Data_Maybe.Just.create)(str);
  };
  var readCnamePname = function (__dict_MonadError_0) {
      return function (s) {
          return function (f) {
              return function (_32) {
                  var _42 = Data_StrMap.lookup("cname")(_32.params);
                  if (_42 instanceof Data_Maybe.Nothing) {
                      return Control_Monad_Error_Class.throwError(__dict_MonadError_0)(Control_Monad_Eff_Exception.error(s + ": No computername provided"));
                  };
                  if (_42 instanceof Data_Maybe.Just) {
                      var _43 = Data_StrMap.lookup("pname")(_32.params);
                      if (_43 instanceof Data_Maybe.Nothing) {
                          return Control_Monad_Error_Class.throwError(__dict_MonadError_0)(Control_Monad_Eff_Exception.error(s + ": No profilename provided"));
                      };
                      if (_43 instanceof Data_Maybe.Just) {
                          return f(_42.value0)(_43.value0);
                      };
                      throw new Error("Failed pattern match at Main line 300, column 1 - line 301, column 1: " + [ _43.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main line 300, column 1 - line 301, column 1: " + [ _42.constructor.name ]);
              };
          };
      };
  };
  ...
  var queryNewImages = function (conn) {
      return function (cname) {
          return function (d) {
              var q = Database_AnyDB.Query("Select * from IMAGES i " + ("Join Events e on e.id = i.eventid " + ("where e.computername = ? " + "and i.updatedon > ? ")));
              return Database_AnyDB.query(App_Model_SavedImage.savedImageIsForeign)(q)([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(cname), Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueDate)(d) ])(conn);
          };
      };
  };
  ...
  var port = 8080;
  var mymonthlystatistic = new App_Model_Statistic.MonthlyStatistic({
      month: 1, 
      computername: "mycomputername", 
      pictures: 500, 
      prints: 390
  });
  var myeventstatistic = new App_Model_Statistic.EventStatistic({
      eventId: 1, 
      computername: "mycomputername", 
      pictures: 200, 
      prints: 190
  ...
  var myevent = function (d) {
      return new App_Model_Event.Event({
          id: Data_Maybe.Nothing.value, 
          computername: "mycomputername", 
  ...
  var mybooth = new App_Model_Photobooth.Photobooth({
      id: Data_Maybe.Nothing.value, 
      computername: "mycomputername", 
      alias: "myalias", 
      defaultprofile: "myprofile"
  });
  var insertPB = function (_21) {
      return SQL.insert(App_Model_Photobooth.photoboothsTable)(App_Model_StrMap.fromArray([ new Data_Tuple.Tuple("computername", _21.value0.computername), new Data_Tuple.Tuple("alias", _21.value0.alias), new Data_Tuple.Tuple("defaultprofile", _21.value0.defaultprofile) ]))(false)("");
  };
  var insertEvent = function (_23) {
      return SQL.insert(App_Model_Event.eventsTable)(App_Model_StrMap.fromArray([ new Data_Tuple.Tuple("computername", _23.value0.computername), new Data_Tuple.Tuple("name", _23.value0.name), Data_Tuple.Tuple.create("datefrom")(App_Model_Date.iso8601(_23.value0.datefrom)), Data_Tuple.Tuple.create("dateuntil")(App_Model_Date.iso8601(_23.value0.dateuntil)), Data_Tuple.Tuple.create("profile")(_23.value0.profile) ]))(false)("");
  };
  var findProfileFiles = function (cname) {
      return function (pname) {
          return Prelude["<$>"](Control_Monad_Aff.functorAff)(Prelude["<$>"](Prelude.functorArray)(function (path) {
              return Node_Path.concat([ cname, pname, path ]);
          }))(Node_FS_Aff.readdir(Node_Path.concat([ "./profiles", cname, pname ])));
      };
  };
  ...
  var eventsByCname = function (_19) {
      var _52 = Data_StrMap.lookup("cname")(_19.params);
      ...
      if (_52 instanceof Data_Maybe.Just) {
          var q = SQL.selectStar(App_Model_Event.eventsTable)(" WHERE computername = '" + (_52.value0 + "'"));
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query_(App_Model_Event.partialEventIsForeign)(q)(conn))(function (_3) {
                  var ids = Prelude["<$>"](Prelude.functorArray)(function (_16) {
                      return Data_Maybe.fromMaybe(0)(_16.value0.id);
                  })(_3);
                  return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                      var _57 = Data_Array.length(ids) > 0;
                      if (_57) {
                          return selectImagesForEvents(ids)(conn);
                      };
                      if (!_57) {
                          return Prelude["return"](Control_Monad_Aff.applicativeAff)([  ]);
                      };
                      throw new Error("Failed pattern match at Main line 140, column 1 - line 141, column 1: " + [ _57.constructor.name ]);
                  })())(function (_2) {
                      var createEvent = function (_34) {
                          return App_Model_Event.mkEvent(_34)(Data_Array.filter(function (_17) {
                              return _17.value0.eventId === Data_Maybe.fromMaybe(0)(_34.value0.id);
                          })(_2));
                      };
      ...
      throw new Error("Failed pattern match at Main line 140, column 1 - line 141, column 1: " + [ _52.constructor.name ]);
  };
  var newEvent = function (_22) {
      return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(insertEvent(_22.body))(conn))(function () {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Event.partialEventIsForeign)(SQL.selectLastInserted(App_Model_Event.eventsTable))(conn))(function (_5) {
                  ...
                  throw new Error("Failed pattern match at Main line 167, column 1 - line 168, column 1: " + [ _5.constructor.name ]);
              });
          });
      });
  };
  var newPB = function (_20) {
      return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(insertPB(_20.body))(conn))(function () {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Photobooth.photoboothIsForeign)(SQL.selectLastInserted(App_Model_Photobooth.photoboothsTable))(conn))(function (_4) {
  ...
  var readCname = function (s) {
      return function (f) {
          return function (_30) {
              var _83 = Data_StrMap.lookup("cname")(_30.params);
              if (_83 instanceof Data_Maybe.Nothing) {
                  return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error(s + ": No computername provided"));
              };
              if (_83 instanceof Data_Maybe.Just) {
                  return Database_AnyDB.withConnection(connectionInfo)(function (c) {
                      return f(c)(_83.value0);
                  });
              };
              throw new Error("Failed pattern match at Main line 284, column 1 - line 285, column 1: " + [ _83.constructor.name ]);
          };
      };
  };
  var readCnameDate = function (s) {
      return function (f) {
          return function (_31) {
              var _89 = Data_StrMap.lookup("cname")(_31.params);
              if (_89 instanceof Data_Maybe.Nothing) {
                  return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error(s + ": No computername provided"));
              };
              if (_89 instanceof Data_Maybe.Just) {
                  var _90 = Data_StrMap.lookup("date")(_31.params);
                  if (_90 instanceof Data_Maybe.Nothing) {
                      return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error(s + ": No date provided"));
                  };
                  if (_90 instanceof Data_Maybe.Just) {
                      var _91 = Data_Date.fromStringStrict(_90.value0);
                      if (_91 instanceof Data_Maybe.Nothing) {
                          return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error(s + ": Invalid date provided"));
                      };
                      if (_91 instanceof Data_Maybe.Just) {
                          return Database_AnyDB.withConnection(connectionInfo)(function (c) {
                              return f(c)(_89.value0)(_91.value0);
                          });
                      };
                      throw new Error("Failed pattern match at Main line 290, column 1 - line 291, column 1: " + [ _91.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main line 290, column 1 - line 291, column 1: " + [ _90.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main line 290, column 1 - line 291, column 1: " + [ _89.constructor.name ]);
          };
      };
  };
  var saveImageToDb = function (_26) {
      var _97 = Data_StrMap.lookup("eventid")(_26.params);
      ...
      if (_97 instanceof Data_Maybe.Just) {
          var _98 = safeParseInt(_97.value0);
          if (_98 instanceof Data_Maybe.Nothing) {
              return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("SaveImageToDb: Failed to parse: " + _97.value0));
          };
          if (_98 instanceof Data_Maybe.Just) {
              var _99 = Data_StrMap.lookup("name")(_26.params);
              ...
              if (_99 instanceof Data_Maybe.Just) {
                  return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
                      var query = Database_AnyDB.Query("INSERT INTO " + (App_Model_SavedImage.savedImageTable.name + " (name, eventid, image) VALUES (?, ?, ?)"));
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute(query)([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(_99.value0), Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueInt)(_98.value0), Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueBuffer)(_26.body) ])(conn))(function () {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_SavedImage.savedImageIsForeign)(SQL.selectLastInserted(App_Model_SavedImage.savedImageTable))(conn))(function (_8) {
              ...
              throw new Error("Failed pattern match at Main line 214, column 1 - line 215, column 1: " + [ _99.constructor.name ]);
          };
          throw new Error("Failed pattern match at Main line 214, column 1 - line 215, column 1: " + [ _98.constructor.name ]);
      };
      throw new Error("Failed pattern match at Main line 214, column 1 - line 215, column 1: " + [ _97.constructor.name ]);
  };
  var updateEvent = function (_25) {
      if (_25.body.value0.id instanceof Data_Maybe.Nothing) {
      ...
      if (_25.body.value0.id instanceof Data_Maybe.Just) {
          var query = SQL.update(App_Model_Event.eventsTable)(_25.body.value0.id.value0)(App_Model_StrMap.fromArray([ new Data_Tuple.Tuple("computername", _25.body.value0.computername), new Data_Tuple.Tuple("name", _25.body.value0.name), Data_Tuple.Tuple.create("datefrom")(App_Model_Date.iso8601(_25.body.value0.datefrom)), Data_Tuple.Tuple.create("dateuntil")(App_Model_Date.iso8601(_25.body.value0.dateuntil)), new Data_Tuple.Tuple("profile", _25.body.value0.profile) ]))("");
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(query)(conn))(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Event.partialEventIsForeign)(SQL.selectStarId(App_Model_Event.eventsTable)(_25.body.value0.id.value0))(conn))(function (_7) {
                      ...
                      if (_7 instanceof Data_Maybe.Just && _7.value0.value0.id instanceof Data_Maybe.Nothing) {
                          return Prelude["return"](Control_Monad_Aff.applicativeAff)(App_Model_Event.mkEvent(_7.value0)([  ]));
                      };
                      if (_7 instanceof Data_Maybe.Just && _7.value0.value0.id instanceof Data_Maybe.Just) {
                          return Prelude[">>="](Control_Monad_Aff.bindAff)(selectImagesForEvent(_7.value0.value0.id.value0)(conn))(function (ims) {
                              return Prelude["return"](Control_Monad_Aff.applicativeAff)(App_Model_Event.mkEvent(_7.value0)(ims));
                          });
                      };
                      throw new Error("Failed pattern match at Main line 196, column 1 - line 197, column 1: " + [ _7.constructor.name ]);
                  });
              });
          });
      };
      throw new Error("Failed pattern match at Main line 196, column 1 - line 197, column 1: " + [ _25.constructor.name ]);
  };
  var updatePB = function (_24) {
      if (_24.body.value0.id instanceof Data_Maybe.Nothing) {
      ...
      if (_24.body.value0.id instanceof Data_Maybe.Just) {
          var query = SQL.update(App_Model_Photobooth.photoboothsTable)(_24.body.value0.id.value0)(App_Model_StrMap.fromArray([ new Data_Tuple.Tuple("alias", _24.body.value0.alias), new Data_Tuple.Tuple("defaultprofile", _24.body.value0.defaultprofile) ]))("");
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(query)(conn))(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Photobooth.photoboothIsForeign)(SQL.selectStarId(App_Model_Photobooth.photoboothsTable)(_24.body.value0.id.value0))(conn))(function (_6) {
      ...
      throw new Error("Failed pattern match at Main line 186, column 1 - line 187, column 1: " + [ _24.constructor.name ]);
  };
  var allStatistics = function (_29) {
      var _135 = Data_StrMap.lookup("cname")(_29.params);
      if (_135 instanceof Data_Maybe.Nothing) {
          return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("GetStatistics: No computername provided"));
      };
      if (_135 instanceof Data_Maybe.Just) {
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query(App_Model_Statistic.eventStatisticIsForeign)("select * from eventstatistics where computername = ?")([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(_135.value0) ])(conn))(function (_12) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query(App_Model_Statistic.monthlyStatisticIsForeign)("select * from monthlystatistics where computername = ?")([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(_135.value0) ])(conn))(function (_11) {
                      return Prelude["return"](Control_Monad_Aff.applicativeAff)(new App_Model_Statistic.AllStatistics({
                          eventStatistics: _12, 
                          monthlyStatistics: _11
                      }));
                  });
              });
          });
      };
      throw new Error("Failed pattern match at Main line 262, column 1 - line 263, column 1: " + [ _135.constructor.name ]);
  };
  var allProfiles = (function () {
      var prof = Node_Path.normalize("./profiles");
      return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.readdir(prof))(function (_10) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Prelude.flip(Data_Array.filterM(Control_Monad_Aff.monadAff))(_10)(function (path) {
              return Prelude[">>="](Control_Monad_Aff.bindAff)(Node_FS_Aff.stat(Node_Path.concat([ prof, path ])))(function (_153) {
                  return Prelude["return"](Control_Monad_Aff.applicativeAff)(Node_FS_Stats.isDirectory(_153));
              });
          }))(function (_9) {
              return Prelude.flip(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff))(_9)(function (dir) {
                  return Prelude[">>="](Control_Monad_Aff.bindAff)(Node_FS_Aff.readdir(Node_Path.concat([ prof, dir ])))(function (profiles) {
                      return Prelude["return"](Control_Monad_Aff.applicativeAff)(new Data_Tuple.Tuple(dir, profiles));
                  });
              });
          });
      });
  })();
  var allPhotobooths = function (_18) {
      return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
  ...
  var addStatistics = function (c) {
      return function (_33) {
          ...
          })(_33.value0.monthlyStatistics))(function (_14) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(function (s) {
                  return Database_AnyDB.execute_(upsertEventStatistic(s))(c);
              })(_33.value0.eventStatistics))(function (_13) {
  ...
  var main = function __do() {
      ...
      Control_Monad_Aff.runAff(function (_154) {
          return Control_Monad_Eff_Console.log(Prelude.show(Control_Monad_Eff_Exception.showError)(_154));
                                          ...
                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(SQL.updatedonInsertTrigger(App_Model_Event.eventsTable)([ "id" ]))(conn))(function () {
                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(SQL.updatedonUpdateTrigger(App_Model_Event.eventsTable)([ "id" ]))(conn))(function () {
                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(insertEvent(myevent(_1)))(conn))(function () {
                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(SQL.dropTable(App_Model_SavedImage.savedImageTable))(conn))(function () {
                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(SQL.createTable(App_Model_SavedImage.savedImageTable))(conn))(function () {
                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(SQL.updatedonInsertTrigger(App_Model_SavedImage.savedImageTable)([ "id" ]))(conn))(function () {
                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(SQL.updatedonUpdateTrigger(App_Model_SavedImage.savedImageTable)([ "id" ]))(conn))(function () {
                                                                          ...
                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(App_Model_Statistic.createEventStatisticsTable)(conn))(function () {
                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(SQL.updatedonInsertTrigger(App_Model_Statistic.eventStatisticsTable)([ "computername", "eventid" ]))(conn))(function () {
                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(SQL.updatedonUpdateTrigger(App_Model_Statistic.eventStatisticsTable)([ "computername", "eventid" ]))(conn))(function () {
                                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(upsertEventStatistic(myeventstatistic))(conn))(function () {
                                                                                              ...
                                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(App_Model_Statistic.createMonthlyStatisticsTable)(conn))(function () {
                                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(SQL.updatedonInsertTrigger(App_Model_Statistic.monthlyStatisticsTable)([ "computername", "month" ]))(conn))(function () {
                                                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(SQL.updatedonUpdateTrigger(App_Model_Statistic.monthlyStatisticsTable)([ "computername", "month" ]))(conn))(function () {
                                                                                                          return Database_AnyDB.execute_(upsertMonthlyStatistic(mymonthlystatistic))(conn);
                                                                                                      });
                                                                                                  });
                                                                                              });
                                                                                          });
      ...
      Server_Core.hostEndpoint(Data_Generic.genericUnit)(Data_Generic.genericMaybe(App_Model_Photobooth.genericPhotobooth))(_0)(App_Endpoint.getPhotobooth)(readCname("GetPhotobooth")(queryPhotobooth))();
      Server_Core.hostEndpoint(Data_Generic.genericUnit)(Data_Generic.genericArray(App_Model_Photobooth.genericPhotobooth))(_0)(App_Endpoint.getPhotobooths)(allPhotobooths)();
      Server_Core.hostEndpoint(App_Model_Photobooth.genericPhotobooth)(App_Model_Photobooth.genericPhotobooth)(_0)(App_Endpoint.postPhotobooths)(newPB)();
      Server_Core.hostEndpoint(App_Model_Photobooth.genericPhotobooth)(App_Model_Photobooth.genericPhotobooth)(_0)(App_Endpoint.putPhotobooths)(updatePB)();
      Server_Core.hostEndpoint(Data_Generic.genericUnit)(Data_Generic.genericArray(App_Model_Event.genericEvent))(_0)(App_Endpoint.getEvents)(eventsByCname)();
      Server_Core.hostEndpoint(App_Model_Event.genericEvent)(App_Model_Event.genericEvent)(_0)(App_Endpoint.postEvents)(newEvent)();
      Server_Core.hostEndpoint(App_Model_Event.genericEvent)(App_Model_Event.genericEvent)(_0)(App_Endpoint.putEvents)(updateEvent)();
      Server_Core.hostEndpoint(Data_Generic.genericUnit)(Data_Generic.genericArray(App_Model_Event.genericPartialEvent))(_0)(App_Endpoint.getNewEvents)(readCnameDate("GetNewEvents")(queryNewEvents))();
      ...
      Server_Core.hostEndpoint(Data_Generic.genericUnit)(App_Model_Statistic.genericAllStatistics)(_0)(App_Endpoint.getStatistics)(allStatistics)();
      Server_Core.hostEndpoint(Data_Generic.genericUnit)(Data_Generic.genericArray(App_Model_SavedImage.genericSavedImage))(_0)(App_Endpoint.getNewImages)(readCnameDate("GetNewImages")(queryNewImages))();
      Server_Core.hostEndpoint(App_Model_Statistic.genericAllStatistics)(Data_Generic.genericUnit)(_0)(App_Endpoint.postStatistics)(function (_15) {
          return Database_AnyDB.withConnection(connectionInfo)(function (c) {
              return addStatistics(c)(_15.body);
          });
      })();
      Server_Core.hostEndpoint(Data_Generic.genericUnit)(Data_Generic.genericArray(Data_Generic.genericString))(_0)(App_Endpoint.getProfileFiles)(readCnamePname(Control_Monad_Aff.monadErrorAff)("GetProfileFiles")(findProfileFiles))();
      Server_Core.hostFileEndpoint(App_Model_SavedImage.genericSavedImage)(_0)(App_Endpoint.attachImage)(saveImageToDb)();
  ...
  exports["queryNewImages"] = queryNewImages;
  exports["queryPhotobooth"] = queryPhotobooth;
  exports["readCnamePname"] = readCnamePname;
  exports["readCnameDate"] = readCnameDate;
  exports["readCname"] = readCname;
  ...
  exports["main"] = main;
  exports["port"] = port;
  exports["mymonthlystatistic"] = mymonthlystatistic;
  exports["myeventstatistic"] = myeventstatistic;
