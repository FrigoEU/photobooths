                  ...
                  return Prelude.bind(dictMonad["__superclass_Prelude.Bind_1"]())(p(x))(function (v) {
                      return Prelude.bind(dictMonad["__superclass_Prelude.Bind_1"]())(filterM(dictMonad)(p)(xs))(function (v1) {
                          return Prelude["return"](dictMonad["__superclass_Prelude.Applicative_0"]())((function () {
                              ...
                              throw new Error("Failed pattern match at Data.Array line 382, column 5 - line 388, column 1: " + [ v.constructor.name ]);
                          })());
                      });
                  });
              };
...
(function(exports) {
  ...
  var updatePB = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at App.DB line 187, column 1 - line 189, column 1: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
          ...
          if (v1.value0.id instanceof Data_Maybe.Just) {
              ...
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(query)(v))(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Event.partialEventIsForeign)(SQL.selectStarId(App_Model_Event.eventsTable)(v1.value0.id.value0))(v))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at App.DB line 215, column 7 - line 220, column 1: " + [ v2.constructor.name ]);
                  });
              });
          };
          throw new Error("Failed pattern match at App.DB line 203, column 1 - line 205, column 1: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
      ...
      return function (ev) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(insertEvent(ev))(conn))(function () {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Event.partialEventIsForeign)(SQL.selectLastInserted(App_Model_Event.eventsTable))(conn))(function (v) {
                  ...
                  throw new Error("Failed pattern match at App.DB line 162, column 5 - line 167, column 1: " + [ v.constructor.name ]);
              });
          });
      };
  };
  ...
  var getFileById = function (conn) {
      return function (id) {
          return Prelude[">>="](Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne(foreignBufferForHttp)("select file from files where id = ?")([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueInt)(id) ])(conn))(function (mf) {
              return Data_Maybe.maybe(Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("No file found")))(function ($125) {
                  return Prelude["return"](Control_Monad_Aff.applicativeAff)(unpack($125));
              })(mf);
          });
      };
  };
  ...
  var addFilesToEvents = function (conn) {
      return function (partialEvs) {
          ...
          return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
              ...
              throw new Error("Failed pattern match at App.DB line 132, column 12 - line 133, column 3: " + [ $117.constructor.name ]);
          })())(function (v) {
              ...
              return function (app) {
                  return function (v) {
                      return function (h) {
                          ...
                          throw new Error("Failed pattern match at Server.Core line 61, column 3 - line 66, column 3: " + [ v.value0.method.constructor.name ]);
                      };
                  };
              };
          };
