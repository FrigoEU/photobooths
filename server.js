...
(function(exports) {
  ...
  var showFieldType = new Prelude.Show(function (_10) {
      ...
      throw new Error("Failed pattern match at SQL line 34, column 1 - line 40, column 1: " + [ _10.constructor.name ]);
  });
  var showColumnConstraint = new Prelude.Show(function (_11) {
      ...
      throw new Error("Failed pattern match at SQL line 40, column 1 - line 44, column 1: " + [ _11.constructor.name ]);
  });
  var showColumnDef = new Prelude.Show(function (_9) {
      return Prelude.show(showFieldType)(_9.value0) + ((function () {
          ...
          throw new Error("Failed pattern match at SQL line 30, column 1 - line 34, column 1: " + [ _28.constructor.name ]);
...
(function(exports) {
  ...
  var createMonthlyStatisticsTable = "CREATE TABLE MONTHLYSTATISTICS (computername CHAR, month INTEGER, pictures INTEGER, prints INTEGER, PRIMARY KEY (computername, month))";
  var createEventStatisticsTable = "CREATE TABLE EVENTSTATISTICS (computername CHAR, eventId INTEGER, pictures INTEGER, prints INTEGER, PRIMARY KEY (computername, eventId))";
...
(function(exports) {
  ...
  var stat = function (file) {
      return function (cb) {
          return Node_FS_Internal.mkEff(function (_4) {
              return $foreign.fs.stat(file, handleCallback(function (_46) {
                  return cb(Prelude["<$>"](Data_Either.functorEither)(Node_FS_Stats.Stats.create)(_46));
              }));
          });
      };
  };
          ...
          return function (app) {
              return function (_12) {
                  return function (f) {
                      ...
                      throw new Error("Failed pattern match at Server.Core line 52, column 1 - line 55, column 1: " + [ app.constructor.name, _12.constructor.name, f.constructor.name ]);
                  };
              };
          };
      };
...
(function(exports) {
  ...
  var insertPB = function (_19) {
      return SQL.insert(App_Model_Photobooth.photoboothsTable)(App_Model_StrMap.fromArray([ new Data_Tuple.Tuple("computername", _19.value0.computername), new Data_Tuple.Tuple("alias", _19.value0.alias), new Data_Tuple.Tuple("defaultprofile", _19.value0.defaultprofile) ]))("");
  };
  var insertMonthlyStatistic = function (_26) {
      return SQL.insert(App_Model_Statistic.monthlyStatisticsTable)(App_Model_StrMap.fromArray([ Data_Tuple.Tuple.create("month")(Prelude.show(Prelude.showInt)(_26.value0.month)), Data_Tuple.Tuple.create("computername")(_26.value0.computername), Data_Tuple.Tuple.create("pictures")(Prelude.show(Prelude.showInt)(_26.value0.pictures)), Data_Tuple.Tuple.create("prints")(Prelude.show(Prelude.showInt)(_26.value0.prints)) ]))("");
  };
  var insertEventStatistic = function (_25) {
      return SQL.insert(App_Model_Statistic.eventStatisticsTable)(App_Model_StrMap.fromArray([ Data_Tuple.Tuple.create("eventId")(Prelude.show(Prelude.showInt)(_25.value0.eventId)), Data_Tuple.Tuple.create("computername")(_25.value0.computername), Data_Tuple.Tuple.create("pictures")(Prelude.show(Prelude.showInt)(_25.value0.pictures)), Data_Tuple.Tuple.create("prints")(Prelude.show(Prelude.showInt)(_25.value0.prints)) ]))("");
  };
  var insertEvent = function (_21) {
      return SQL.insert(App_Model_Event.eventsTable)(App_Model_StrMap.fromArray([ new Data_Tuple.Tuple("computername", _21.value0.computername), new Data_Tuple.Tuple("name", _21.value0.name), Data_Tuple.Tuple.create("datefrom")(App_Model_Date.iso8601(_21.value0.datefrom)), Data_Tuple.Tuple.create("dateuntil")(App_Model_Date.iso8601(_21.value0.dateuntil)), Data_Tuple.Tuple.create("profile")(_21.value0.profile) ]))("");
  };
  var connectionInfo = new Database_AnyDB.Sqlite3({
      filename: "klikhutdb", 
      memory: false
  });
  var eventsByCname = function (_17) {
      var _42 = Data_StrMap.lookup("cname")(_17.params);
      ...
      if (_42 instanceof Data_Maybe.Just) {
          var q = SQL.selectStar(App_Model_Event.eventsTable)(" WHERE computername = '" + (_42.value0 + "'"));
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query_(App_Model_Event.partialEventIsForeign)(q)(conn))(function (_3) {
                  var ids = Prelude["<$>"](Prelude.functorArray)(function (_13) {
                      if (_13.value0.id instanceof Data_Maybe.Just) {
                          return _13.value0.id.value0;
                      };
                      throw new Error("Failed pattern match at Main line 129, column 19 - line 130, column 15: " + [ _13.constructor.name ]);
                  })(_3);
                  return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                      var _48 = Data_Array.length(ids) > 0;
                      if (_48) {
                      ...
                      throw new Error("Failed pattern match at Main line 121, column 1 - line 122, column 1: " + [ _48.constructor.name ]);
                  })())(function (_2) {
                      var createEvent = function (_28) {
                          if (_28.value0.id instanceof Data_Maybe.Just) {
                              return App_Model_Event.mkEvent(_28)(Data_Array.filter(function (_14) {
                                  return _14.value0.eventId === _28.value0.id.value0;
                              })(_2));
                          };
                          throw new Error("Failed pattern match at Main line 131, column 19 - line 132, column 15: " + [ _28.constructor.name ]);
                      };
      ...
      throw new Error("Failed pattern match at Main line 121, column 1 - line 122, column 1: " + [ _42.constructor.name ]);
  };
  var newEvent = function (_20) {
      return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(insertEvent(_20.body))(conn))(function () {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Event.partialEventIsForeign)(SQL.selectLastInserted(App_Model_Event.eventsTable))(conn))(function (_5) {
                  ...
                  throw new Error("Failed pattern match at Main line 148, column 1 - line 149, column 1: " + [ _5.constructor.name ]);
              });
          });
      });
  };
  var newPB = function (_18) {
      return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(insertPB(_18.body))(conn))(function () {
  ...
  var saveImageToDb = function (_24) {
      var _73 = Data_StrMap.lookup("eventid")(_24.params);
      ...
      if (_73 instanceof Data_Maybe.Just) {
          var _74 = safeParseInt(_73.value0);
          if (_74 instanceof Data_Maybe.Nothing) {
              return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("SaveImageToDb: Failed to parse: " + _73.value0));
          };
          if (_74 instanceof Data_Maybe.Just) {
              var _75 = Data_StrMap.lookup("name")(_24.params);
              if (_75 instanceof Data_Maybe.Nothing) {
              ...
              if (_75 instanceof Data_Maybe.Just) {
                  return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
                      var query = Database_AnyDB.Query("INSERT INTO " + (App_Model_SavedImage.savedImageTable.name + " (name, eventid, image) VALUES (?, ?, ?)"));
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute(query)([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(_75.value0), Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueInt)(_74.value0), Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueBuffer)(_24.body) ])(conn))(function () {
              ...
              throw new Error("Failed pattern match at Main line 195, column 1 - line 196, column 1: " + [ _75.constructor.name ]);
          };
          throw new Error("Failed pattern match at Main line 195, column 1 - line 196, column 1: " + [ _74.constructor.name ]);
      };
      throw new Error("Failed pattern match at Main line 195, column 1 - line 196, column 1: " + [ _73.constructor.name ]);
  };
      ...
      if (_23.body.value0.id instanceof Data_Maybe.Just) {
          ...
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(query)(conn))(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Event.partialEventIsForeign)(SQL.selectStarId(App_Model_Event.eventsTable)(_23.body.value0.id.value0))(conn))(function (_7) {
                      ...
                      throw new Error("Failed pattern match at Main line 177, column 1 - line 178, column 1: " + [ _7.constructor.name ]);
                  });
              });
          });
      };
      throw new Error("Failed pattern match at Main line 177, column 1 - line 178, column 1: " + [ _23.constructor.name ]);
  };
  var updatePB = function (_22) {
      ...
      if (_22.body.value0.id instanceof Data_Maybe.Just) {
          ...
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(query)(conn))(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Photobooth.photoboothIsForeign)(SQL.selectStarId(App_Model_Photobooth.photoboothsTable)(_22.body.value0.id.value0))(conn))(function (_6) {
      ...
      throw new Error("Failed pattern match at Main line 167, column 1 - line 168, column 1: " + [ _22.constructor.name ]);
  };
  var allStatistics = function (_27) {
      var _111 = Data_StrMap.lookup("cname")(_27.params);
      ...
      if (_111 instanceof Data_Maybe.Just) {
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query(App_Model_Statistic.eventStatisticIsForeign)("select * from eventstatistics where computername = ?")([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(_111.value0) ])(conn))(function (_12) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query(App_Model_Statistic.monthlyStatisticIsForeign)("select * from monthlystatistics where computername = ?")([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(_111.value0) ])(conn))(function (_11) {
      ...
      throw new Error("Failed pattern match at Main line 241, column 1 - line 242, column 1: " + [ _111.constructor.name ]);
  };
  var allProfiles = (function () {
      ...
      return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.readdir(prof))(function (_10) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Prelude.flip(Data_Array.filterM(Control_Monad_Aff.monadAff))(_10)(function (path) {
              return Prelude[">>="](Control_Monad_Aff.bindAff)(Node_FS_Aff.stat(Node_Path.concat([ prof, path ])))(function (_120) {
                  return Prelude["return"](Control_Monad_Aff.applicativeAff)(Node_FS_Stats.isDirectory(_120));
              });
          }))(function (_9) {
  ...
  var allPhotobooths = function (_16) {
      return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
  ...
  var main = function __do() {
      ...
      Control_Monad_Aff.runAff(function (_121) {
          return Control_Monad_Eff_Console.log(Prelude.show(Control_Monad_Eff_Exception.showError)(_121));
                                          ...
                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(SQL.createTable(App_Model_SavedImage.savedImageTable))(conn))(function () {
                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(SQL.dropTable(App_Model_Statistic.eventStatisticsTable))(conn))(function () {
                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(App_Model_Statistic.createEventStatisticsTable)(conn))(function () {
                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(insertEventStatistic(myeventstatistic))(conn))(function () {
                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(SQL.dropTable(App_Model_Statistic.monthlyStatisticsTable))(conn))(function () {
                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(App_Model_Statistic.createMonthlyStatisticsTable)(conn))(function () {
                                                                  return Database_AnyDB.execute_(insertMonthlyStatistic(mymonthlystatistic))(conn);
                                                              });
                                                          });
                                                      });
                                                  });
      ...
      Server_Core.hostFile(_0)("*")($$static)();
  ...
  exports["insertMonthlyStatistic"] = insertMonthlyStatistic;
  exports["insertEventStatistic"] = insertEventStatistic;
