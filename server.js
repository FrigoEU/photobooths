...
(function(exports) {
  ...
  var updatePB = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at App.DB line 212, column 1 - line 214, column 1: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  ...
  var queryNewFiles = function (conn) {
      return function (v) {
          ...
          return Database_AnyDB.query(App_Model_SavedFile.savedFileIsForeign)(q)([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(v.value0), Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(App_Model_Date.toISOString(v.value1)) ])(conn);
      };
  };
  var queryNewEvents = function (conn) {
      return function (v) {
          var q = Database_AnyDB.Query("Select * from EVENTS " + ("where computername = ? " + "and updatedon > ?"));
          return Database_AnyDB.query(App_Model_Event.partialEventIsForeign)(q)([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(v.value0), Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(App_Model_Date.toISOString(v.value1)) ])(conn);
      };
  };
  ...
  var parseQueryParams = function (dictSerializable) {
      return function (dictMonadError) {
          return function (v) {
              ...
              })(getParams(Global["decodeURI"](v.url))));
          };
      };
  };
              ...
              return function (app) {
                  return function (v) {
                      return function (h) {
                          ...
                          throw new Error("Failed pattern match at Server.Core line 62, column 3 - line 67, column 3: " + [ v.value0.method.constructor.name ]);
                      };
                  };
              };
          };
