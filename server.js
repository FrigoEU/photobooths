...
(function(exports) {
  ...
  var eventsByCname = function (_15) {
          ...
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query_(App_Model_Event.partialEventIsForeign)(q)(conn))(function (_1) {
                  ...
                  return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                      ...
                      throw new Error("Failed pattern match at App.DB line 118, column 1 - line 119, column 1: " + [ _57.constructor.name ]);
                  })())(function (_0) {
      ...
      throw new Error("Failed pattern match at App.DB line 118, column 1 - line 119, column 1: " + [ _52.constructor.name ]);
  };
  var getFileById = function (_31) {
      ...
      throw new Error("Failed pattern match at App.DB line 313, column 1 - line 314, column 1: " + [ _67.constructor.name ]);
  };
      ...
      return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(insertEvent(_19.body))(conn))(function () {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Event.partialEventIsForeign)(SQL.selectLastInserted(App_Model_Event.eventsTable))(conn))(function (_3) {
                  ...
                  throw new Error("Failed pattern match at App.DB line 153, column 1 - line 154, column 1: " + [ _3.constructor.name ]);
              });
          });
      });
  };
  ...
  var saveFileToDb = function (_25) {
      ...
      if (_85 instanceof Data_Maybe.Just) {
          ...
          if (_86 instanceof Data_Maybe.Just) {
              ...
              throw new Error("Failed pattern match at App.DB line 217, column 1 - line 218, column 1: " + [ _87.constructor.name ]);
          };
          throw new Error("Failed pattern match at App.DB line 217, column 1 - line 218, column 1: " + [ _86.constructor.name ]);
      };
      throw new Error("Failed pattern match at App.DB line 217, column 1 - line 218, column 1: " + [ _85.constructor.name ]);
  };
          ...
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(query)(conn))(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Event.partialEventIsForeign)(SQL.selectStarId(App_Model_Event.eventsTable)(_23.body.value0.id.value0))(conn))(function (_5) {
                      ...
                      throw new Error("Failed pattern match at App.DB line 192, column 1 - line 193, column 1: " + [ _5.constructor.name ]);
                  });
              });
          });
      };
      throw new Error("Failed pattern match at App.DB line 192, column 1 - line 193, column 1: " + [ _23.constructor.name ]);
  };
  var updatePB = function (_22) {
      ...
      throw new Error("Failed pattern match at App.DB line 182, column 1 - line 183, column 1: " + [ _22.constructor.name ]);
  };
  var allStatistics = function (_28) {
      ...
      throw new Error("Failed pattern match at App.DB line 256, column 1 - line 257, column 1: " + [ _123.constructor.name ]);
  };
