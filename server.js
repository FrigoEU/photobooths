...
(function(exports) {
  ...
  var eventsByCname = function (_15) {
      var _52 = Data_StrMap.lookup("cname")(_15.params);
          ...
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query_(App_Model_Event.partialEventIsForeign)(q)(conn))(function (_1) {
                  ...
                  return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                      ...
                      throw new Error("Failed pattern match at App.DB line 116, column 1 - line 117, column 1: " + [ _57.constructor.name ]);
                  })())(function (_0) {
      ...
      throw new Error("Failed pattern match at App.DB line 116, column 1 - line 117, column 1: " + [ _52.constructor.name ]);
  };
  var getFileById = function (_31) {
      var _67 = Data_StrMap.lookup("id")(_31.params);
      ...
      if (_67 instanceof Data_Maybe.Just) {
          return Database_AnyDB.withConnection(connectionInfo)(function (c) {
              return Prelude[">>="](Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne(foreignBufferForHttp)("select file from files where id = ?")([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(_67.value0) ])(c))(function (mf) {
      ...
      throw new Error("Failed pattern match at App.DB line 311, column 1 - line 312, column 1: " + [ _67.constructor.name ]);
  };
      ...
      return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(insertEvent(_19.body))(conn))(function () {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Event.partialEventIsForeign)(SQL.selectLastInserted(App_Model_Event.eventsTable))(conn))(function (_3) {
                  ...
                  throw new Error("Failed pattern match at App.DB line 151, column 1 - line 152, column 1: " + [ _3.constructor.name ]);
              });
          });
      });
  };
  ...
  var saveFileToDb = function (_25) {
      var _85 = Data_StrMap.lookup("eventid")(_25.params);
      ...
      if (_85 instanceof Data_Maybe.Just) {
          var _86 = safeParseInt(_85.value0);
          if (_86 instanceof Data_Maybe.Nothing) {
              return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("SaveFileToDb: Failed to parse: " + _85.value0));
          };
          if (_86 instanceof Data_Maybe.Just) {
              var _87 = Data_StrMap.lookup("name")(_25.params);
              ...
              if (_87 instanceof Data_Maybe.Just) {
                  return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
                      ...
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute(query)([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(_87.value0), Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueInt)(_86.value0), Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueBuffer)(_25.body) ])(conn))(function () {
              ...
              throw new Error("Failed pattern match at App.DB line 215, column 1 - line 216, column 1: " + [ _87.constructor.name ]);
          };
          throw new Error("Failed pattern match at App.DB line 215, column 1 - line 216, column 1: " + [ _86.constructor.name ]);
      };
      throw new Error("Failed pattern match at App.DB line 215, column 1 - line 216, column 1: " + [ _85.constructor.name ]);
  };
          ...
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.execute_(query)(conn))(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne_(App_Model_Event.partialEventIsForeign)(SQL.selectStarId(App_Model_Event.eventsTable)(_23.body.value0.id.value0))(conn))(function (_5) {
                      ...
                      throw new Error("Failed pattern match at App.DB line 190, column 1 - line 191, column 1: " + [ _5.constructor.name ]);
                  });
              });
          });
      };
      throw new Error("Failed pattern match at App.DB line 190, column 1 - line 191, column 1: " + [ _23.constructor.name ]);
  };
  var updatePB = function (_22) {
      ...
      throw new Error("Failed pattern match at App.DB line 180, column 1 - line 181, column 1: " + [ _22.constructor.name ]);
  };
  var allStatistics = function (_28) {
      var _123 = Data_StrMap.lookup("cname")(_28.params);
      ...
      if (_123 instanceof Data_Maybe.Just) {
          return Database_AnyDB.withConnection(connectionInfo)(function (conn) {
              return queryAllStatistics(conn)(_123.value0);
          });
      };
      throw new Error("Failed pattern match at App.DB line 254, column 1 - line 255, column 1: " + [ _123.constructor.name ]);
  };
...
(function(exports) {
          ...
          return function (f) {
              return function (_7) {
                  ...
                  if (_11 instanceof Data_Maybe.Just) {
                      ...
                      throw new Error("Failed pattern match at Main line 91, column 1 - line 92, column 1: " + [ _12.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main line 91, column 1 - line 92, column 1: " + [ _11.constructor.name ]);
              };
          };
      };
  };
          ...
          return function (_6) {
              ...
              if (_19 instanceof Data_Maybe.Just) {
                  ...
                  if (_20 instanceof Data_Maybe.Just) {
                      ...
                      throw new Error("Failed pattern match at Main line 80, column 1 - line 81, column 1: " + [ _21.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main line 80, column 1 - line 81, column 1: " + [ _20.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main line 80, column 1 - line 81, column 1: " + [ _19.constructor.name ]);
          };
      };
  };
  var readCname = function (s) {
      return function (f) {
          return function (_5) {
              ...
              throw new Error("Failed pattern match at Main line 74, column 1 - line 75, column 1: " + [ _29.constructor.name ]);
          };
      };
  };
  var port = 8080;
  ...
  var main = function __do() {
      ...
      Server_Core.hostFile(_0)("files/:id")(App_DB.getFileById)();
