 ...
 */  
          ...
          return function (actual) {
              return function (expected) {
                  return function (text) {
                      ...
                      throw new Error("Failed pattern match at WorkerTest line 225, column 30 - line 228, column 1: " + [ $35.constructor.name ]);
                  };
              };
          };
      };
  ...
  var addEventData = function (workerDB) {
      return function (cname) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Adding Event Data!")))(function () {
