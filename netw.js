...
(function(exports) {
              ...
              return function (target) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint_(Data_Serializable.serializableTuple(Data_Serializable.serializableString)(Data_Serializable.serializableString))(Data_Generic.genericUnit)(Data_Generic.genericArray(Data_Generic.genericString))(baseurl)(App_Endpoint.getProfileFiles)(new Data_Tuple.Tuple(cname, profile))(Prelude.unit))(function (v) {
                      ...
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(function (filename) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableString)(makereq(filename)))(function (v1) {
                              return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Node_Buffer.fromString(v1.response)(Node_Encoding.UTF8.value)))(function (v2) {
                                  return Node_FS_Aff.writeFile(Node_Path.concat([ target, Node_Path.basename(filename) ]))(v2);
                              });
                          });
                      })(v))(function () {
                          return Prelude["return"](Control_Monad_Aff.applicativeAff)(Prelude.unit);
  ...
  var downloadFileById = function (s) {
      return function (i) {
          ...
          return Prelude.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableString)(req))(function (v) {
              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Node_Buffer.fromString(v.response)(Node_Encoding.UTF8.value));
          });
      };
  };
 ...
 */  
  var main = Control_Monad_Aff.runAff(function ($106) {
      return Control_Monad_Eff_Console.log(Prelude.show(Control_Monad_Eff_Exception.showError)($106));
      ...
      return Prelude.bind(Control_Monad_Aff.bindAff)(logToFile("Started networkingscript"))(function () {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Prelude[">>="](Control_Monad_Aff.bindAff)(Node_FS_Aff.stat(logfile))(function (v) {
              ...
              throw new Error("Failed pattern match at App.Networking line 58, column 41 - line 60, column 5: " + [ $52.constructor.name ]);
          }))(function () {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(App_Config.readConfigFile))(function (v) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Either.either(function ($107) {
                      return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error(Prelude.show(Data_Foreign.showForeignError)($107)));
                              ...
                              return Prelude.bind(Control_Monad_Aff.bindAff)(App_DB.queryPhotobooth(conn)(v2))(function (v3) {
                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint_(Data_Serializable.serializableString)(Data_Generic.genericUnit)(Data_Generic.genericMaybe(App_Model_Photobooth.genericPhotobooth))(v1.value0.webServiceHost)(App_Endpoint.getPhotobooth)(v2)(Prelude.unit))(function (v4) {
                                      return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                          ...
                                          throw new Error("Failed pattern match at App.Networking line 74, column 5 - line 77, column 5: " + [ v4.constructor.name ]);
                                      })())(function () {
                                          return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                              var $65 = Prelude["/="](Data_Maybe.eqMaybe(App_Model_Photobooth.eqPhotobooth))(v3)(v4);
                                              if ($65) {
                                              ...
                                              throw new Error("Failed pattern match at App.Networking line 77, column 5 - line 78, column 5: " + [ $65.constructor.name ]);
                                          })())(function () {
                                                      ...
                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(defaultDate(Control_Monad_Aff.monadErrorAff)(v5)(Data_Date.fromStringStrict("2010-01-01T00:00:00.000Z")))(function (v6) {
                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint_(Data_Serializable.serializableTuple(Data_Serializable.serializableString)(Data_Serializable.serializableDate))(Data_Generic.genericUnit)(Data_Generic.genericArray(App_Model_Event.genericPartialEvent))(v1.value0.webServiceHost)(App_Endpoint.getNewEvents)(new Data_Tuple.Tuple(v2, v6))(Prelude.unit))(function (v7) {
                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(function (v8) {
                                                                  ...
                                                                  throw new Error("Failed pattern match at App.Networking line 84, column 15 - line 84, column 74: " + [ v8.constructor.name ]);
                                                              })(v7))(function () {
                                                                                                                              ...
                                                                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.exists(App_FS.defaultDir))(function (v13) {
                                                                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                                                                                                                      ...
                                                                                                                                      if ($84) {
                                                                                                                                          ...
                                                                                                                                          throw new Error("Failed pattern match at App.Networking line 111, column 13 - line 116, column 8: " + [ v4.constructor.name ]);
                                                                                                                                      };
                                                                                                                                      if (!$84) {
                                                                                                                                          return Prelude["return"](Control_Monad_Aff.applicativeAff)(Prelude.unit);
                                                                                                                                      };
                                                                                                                                      throw new Error("Failed pattern match at App.Networking line 110, column 5 - line 121, column 5: " + [ $84.constructor.name ]);
                                                                                                                                  })())(function () {
                                                                                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query(App_Model_Event.partialEventIsForeign)(getEventsByCname)([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(v2) ])(conn))(function (v14) {
                                                                                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Prelude["<$>"](Control_Monad_Aff.functorAff)(Data_Array.filter(Prelude.flip(Data_String_Extended.startsWith)("event_")))(Node_FS_Aff.readdir(Node_Path.normalize("clientprofiles"))))(function (v15) {
                                                                                                                                              ...
                                                                                                                                              var missingEvents = Data_Array.filter(function (v16) {
                                                                                                                                                  ...
                                                                                                                                                  throw new Error("Failed pattern match at App.Networking line 124, column 33 - line 124, column 110: " + [ v16.constructor.name ]);
                                                                                                                                              })(v14);
