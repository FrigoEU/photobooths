...
(function(exports) {
  ...
  var main = Control_Monad_Aff.runAff(function ($101) {
      return Control_Monad_Eff_Console.log(Prelude.show(Control_Monad_Eff_Exception.showError)($101));
      ...
      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(App_Config.readConfigFile))(function (v) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Either.either(function ($102) {
              return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error(Prelude.show(Data_Foreign.showForeignError)($102)));
                              ...
                              return Prelude.bind(Control_Monad_Aff.bindAff)(App_DB.queryPhotobooth(conn)(v2))(function (v3) {
                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint_(Data_Serializable.serializableString)(Data_Generic.genericUnit)(Data_Generic.genericMaybe(App_Model_Photobooth.genericPhotobooth))(v1.value0.webServiceHost)(App_Endpoint.getPhotobooth)(v2)(Prelude.unit))(function (v4) {
                                      return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                          ...
                                          return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                              var $60 = Prelude["/="](Data_Maybe.eqMaybe(App_Model_Photobooth.eqPhotobooth))(v3)(v4);
                                              if ($60) {
                                              ...
                                              throw new Error("Failed pattern match at App.Networking line 66, column 5 - line 67, column 5: " + [ $60.constructor.name ]);
                                          })())(function () {
                                                                                                                          ...
                                                                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(App_FS.safeMkdir(Node_Path.normalize("clientprofiles")))(function () {
                                                                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.exists(App_FS.defaultDir))(function (v13) {
                                                                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                                                                                                                      ...
                                                                                                                                      throw new Error("Failed pattern match at App.Networking line 99, column 5 - line 110, column 5: " + [ $79.constructor.name ]);
                                                                                                                                  })())(function () {
