...
(function(exports) {
  ...
  var readLastUpdated = function (ms) {
      var $38 = Data_Maybe_Unsafe.fromJust(ms);
      return $38.value0;
  };
  ...
  var isForeignLastUpdated = new Data_Foreign_Class.IsForeign(function (obj) {
      return Prelude.bind(Data_Either.bindEither)(Data_Foreign_Class.readProp(Data_Foreign_Class.stringIsForeign)(Data_Foreign_Index.indexString)("lastupdatedon")(obj))(function (v) {
          return Prelude.bind(Data_Either.bindEither)(Data_Maybe.maybe(Data_Either.Left.create(new Data_Foreign.TypeMismatch("Well formed date", v)))(Data_Either.Right.create)(Data_Date.fromString(Data_String.replace(" ")("T")(v) + ".000")))(function (v1) {
              return Prelude["return"](Data_Either.applicativeEither)(new LastUpdated(v1));
          });
      });
  });
  ...
  var main = Control_Monad_Aff.runAff(function (e) {
      ...
      return Prelude.bind(Control_Monad_Aff.bindAff)(logToFile("Started networkingscript"))(function () {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Prelude[">>="](Control_Monad_Aff.bindAff)(Node_FS_Aff.stat(logfile))(function (v) {
              ...
              throw new Error("Failed pattern match at App.Networking line 61, column 41 - line 63, column 5: " + [ $51.constructor.name ]);
          }))(function () {
                              ...
                              return Prelude.bind(Control_Monad_Aff.bindAff)(App_DB.queryPhotobooth(conn)(v2))(function (v3) {
                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint_(Data_Serializable.serializableString)(Data_Generic.genericUnit)(Data_Generic.genericMaybe(App_Model_Photobooth.genericPhotobooth))(v1.value0.webServiceHost)(App_Endpoint.getPhotobooth)(v2)(Prelude.unit))(function (v4) {
                                      return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                          ...
                                          throw new Error("Failed pattern match at App.Networking line 78, column 5 - line 81, column 5: " + [ v4.constructor.name ]);
                                      })())(function () {
                                          return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                              var $64 = Prelude["/="](Data_Maybe.eqMaybe(App_Model_Photobooth.eqPhotobooth))(v3)(v4);
                                              if ($64) {
                                              ...
                                              throw new Error("Failed pattern match at App.Networking line 81, column 5 - line 82, column 5: " + [ $64.constructor.name ]);
                                          })())(function () {
                                              return Prelude.bind(Control_Monad_Aff.bindAff)(logToFile("Synced Photobooth(s)"))(function () {
                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne(isForeignLastUpdated)(getLastUpdateEvents)([  ])(conn))(function (v5) {
                                                      var lastUpdatedEvents = readLastUpdated(v5);
                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint_(Data_Serializable.serializableTuple(Data_Serializable.serializableString)(Data_Serializable.serializableDate))(Data_Generic.genericUnit)(Data_Generic.genericArray(App_Model_Event.genericPartialEvent))(v1.value0.webServiceHost)(App_Endpoint.getNewEvents)(new Data_Tuple.Tuple(v2, lastUpdatedEvents))(Prelude.unit))(function (v6) {
                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(function (v7) {
                                                              if (v7.value0.id instanceof Data_Maybe.Just) {
                                                                  return App_FS.rmdirRecur(App_FS.mkEventDir(v7.value0.id.value0));
                                                              };
                                                              throw new Error("Failed pattern match at App.Networking line 88, column 15 - line 88, column 74: " + [ v7.constructor.name ]);
                                                          })(v6))(function () {
                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB_Transaction.withTransaction(function (tc) {
                                                                  ...
                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(logToFile("Synced Events"))(function () {
                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne(isForeignLastUpdated)(getLastUpdateFiles)([  ])(conn))(function (v7) {
                                                                          var lastUpdatedFiles = readLastUpdated(v7);
                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint_(Data_Serializable.serializableTuple(Data_Serializable.serializableString)(Data_Serializable.serializableDate))(Data_Generic.genericUnit)(Data_Generic.genericArray(App_Model_SavedFile.genericSavedFile))(v1.value0.webServiceHost)(App_Endpoint.getNewFiles)(new Data_Tuple.Tuple(v2, lastUpdatedFiles))(Prelude.unit))(function (v8) {
                                                                              var eventIdsWithNewFiles = Prelude["<$>"](Prelude.functorArray)(function (v9) {
                                                                                  return v9.value0.eventId;
                                                                              })(v8);
                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(function (i) {
                                                                                  ...
                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB_Transaction.withTransaction(function (tc) {
                                                                                      ...
                                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(logToFile("Synced Files"))(function () {
                                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query(isForeignWrappedId)(getEmptyFileEntries)([  ])(conn))(function (v9) {
                                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Prelude.flip(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff))(v9)(function (v10) {
                                                                                                  return Prelude[">>="](Control_Monad_Aff.bindAff)(downloadFileById(v1.value0.webServiceHost)(v10.value0))(function (b) {
                                                                                                      return saveFile(conn)(v10.value0)(b);
                                                                                                  });
                                                                                              }))(function () {
                                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(logToFile("Synced File contents"))(function () {
                                                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(App_DB.queryAllStatistics(conn)(v2))(function (v10) {
                                                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint_(Data_Serializable.serializableUnit)(App_Model_Statistic.genericAllStatistics)(Data_Generic.genericUnit)(v1.value0.webServiceHost)(App_Endpoint.postStatistics)(Prelude.unit)(v10))(function () {
                                                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(logToFile("Synced statistics"))(function () {
                                                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(App_FS.safeMkdir(Node_Path.normalize("clientprofiles")))(function () {
                                                                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.exists(App_FS.defaultDir))(function (v11) {
                                                                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                                                                                                              var $81 = !v11;
                                                                                                                              if ($81) {
                                                                                                                                  if (v4 instanceof Data_Maybe.Nothing) {
                                                                                                                                  ...
                                                                                                                                  throw new Error("Failed pattern match at App.Networking line 115, column 13 - line 120, column 8: " + [ v4.constructor.name ]);
                                                                                                                              };
                                                                                                                              if (!$81) {
                                                                                                                                  return Prelude["return"](Control_Monad_Aff.applicativeAff)(Prelude.unit);
                                                                                                                              };
                                                                                                                              throw new Error("Failed pattern match at App.Networking line 114, column 5 - line 125, column 5: " + [ $81.constructor.name ]);
                                                                                                                          })())(function () {
                                                                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query(App_Model_Event.partialEventIsForeign)(getEventsByCname)([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)(v2) ])(conn))(function (v12) {
                                                                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Prelude["<$>"](Control_Monad_Aff.functorAff)(Data_Array.filter(Prelude.flip(Data_String_Extended.startsWith)("event_")))(Node_FS_Aff.readdir(Node_Path.normalize("clientprofiles"))))(function (v13) {
                                                                                                                                      ...
                                                                                                                                      var missingEvents = Data_Array.filter(function (v14) {
                                                                                                                                          if (v14.value0.id instanceof Data_Maybe.Just) {
                                                                                                                                              return Data_Maybe.isNothing(Data_Array.elemIndex(Prelude.eqInt)(v14.value0.id.value0)(eventIdsFromFolders));
                                                                                                                                          };
                                                                                                                                          throw new Error("Failed pattern match at App.Networking line 128, column 33 - line 128, column 110: " + [ v14.constructor.name ]);
                                                                                                                                      })(v12);
                                                                                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(logToFile("Making event folders for: " + Data_String.joinWith(", ")(Prelude["<$>"](Prelude.functorArray)(function (v14) {
                                                                                                                                          return v14.value0.name;
                                                                                                                                      })(missingEvents))))(function () {
                                                                                                                                          return Prelude.flip(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff))(missingEvents)(function (v14) {
                                                                                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("No id for PartialEvent")))(Prelude["return"](Control_Monad_Aff.applicativeAff))(v14.value0.id))(function (v15) {
                                                                                                                                                  var target = App_FS.mkEventDir(v15);
                                                                                                                                                  var temptarget = App_FS.mkTempEventDir(v15);
                                                                                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(App_FS.rmdirRecur(temptarget))(function () {
                                                                                                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.mkdir(temptarget))(function () {
                                                                                                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(downloadFolder(v1.value0.webServiceHost)(v2)(v14.value0.profile)(temptarget))(function () {
                                                                                                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(getFilesForEvent(conn)(v15))(function (v16) {
                                                                                                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Prelude.flip(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff))(v16)(function (v17) {
                                                                                                                                                                      return App_FS.overWriteFile(Node_Path.concat([ temptarget, v17.value0 ]))(v17.value1);
                                                                                                                                                                  }))(function () {
                                                                                                                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.readdir(temptarget))(function (v17) {
                                                                                                                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(App_FS.copyDir(temptarget)(target))(function () {
                                                                                                                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(App_FS.rmdirRecur(temptarget))(function () {
                                                                                                                                                                                  return logToFile("Made folder for event " + Prelude.show(Prelude.showInt)(v15));
                                                                                                                                                                              });
                                                                                                                                                                          });
                                                                                                                                                                      });
                                                                                                                                                                  });
  ...
  exports["readLastUpdated"] = readLastUpdated;
