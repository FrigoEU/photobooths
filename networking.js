...
(function(exports) {
  ...
  var Data_Either = PS["Data.Either"];
  var Data_Foreign_Index = PS["Data.Foreign.Index"];
  var upsertSavedFile = function (_24) {
      return SQL.insert(App_Model_SavedFile.savedFileTable)(App_Model_StrMap.fromArray([ Data_Tuple.Tuple.create("id")(Prelude.show(Prelude.showInt)(_24.value0.id)), new Data_Tuple.Tuple("name", _24.value0.name), Data_Tuple.Tuple.create("eventId")(Prelude.show(Prelude.showInt)(_24.value0.eventId)) ]))(true)("");
  };
  var upsertPartialEvent = function (_21) {
      ...
      })(_21.value0.id), new Data_Tuple.Tuple("computername", _21.value0.computername), new Data_Tuple.Tuple("name", _21.value0.name), Data_Tuple.Tuple.create("datefrom")(App_Model_Date.iso8601(_21.value0.datefrom)), Data_Tuple.Tuple.create("dateuntil")(App_Model_Date.iso8601(_21.value0.dateuntil)), Data_Tuple.Tuple.create("profile")(_21.value0.profile) ]))(true)("");
  };
  var upsertPB = function (_18) {
      return SQL.insert(App_Model_Photobooth.photoboothsTable)(App_Model_StrMap.fromArray([ Data_Maybe.maybe(Data_Monoid.mempty(Data_Tuple.monoidTuple(Data_Monoid.monoidString)(Data_Monoid.monoidString)))(function (s) {
          return Data_Tuple.Tuple.create("id")(Prelude.show(Prelude.showInt)(s));
      })(_18.value0.id), new Data_Tuple.Tuple("computername", _18.value0.computername), new Data_Tuple.Tuple("alias", _18.value0.alias), new Data_Tuple.Tuple("defaultprofile", _18.value0.defaultprofile) ]))(true)("");
  };
...
(function(exports) {
  ...
  var mkdir$prime = function (file) {
      return function (perms) {
          return function (cb) {
              return Node_FS_Internal.mkEff(function (_14) {
                  return $foreign.fs.mkdir(file, Node_FS_Perms.permsToString(perms), handleCallback(cb));
              });
          };
      };
  };
  ...
  var readFile = function (file) {
      return function (cb) {
          return Node_FS_Internal.mkEff(function (_17) {
              return $foreign.fs.readFile(file, {}, handleCallback(cb));
          });
      };
  };
  ...
  var rmdir = function (file) {
      return function (cb) {
          return Node_FS_Internal.mkEff(function (_13) {
              return $foreign.fs.rmdir(file, handleCallback(cb));
          });
      };
  };
  var unlink = function (file) {
      return function (cb) {
          return Node_FS_Internal.mkEff(function (_12) {
              return $foreign.fs.unlink(file, handleCallback(cb));
          });
      };
  };
      ...
      return function (buff) {
          return function (cb) {
              return Node_FS_Internal.mkEff(function (_19) {
                  return $foreign.fs.writeFile(file, buff, {}, handleCallback(cb));
              });
          };
      };
  };
  var exists = function (file) {
      return function (cb) {
          return Node_FS_Internal.mkEff(function (_23) {
              return $foreign.fs.exists(file, function (b) {
...
(function(exports) {
  ...
  var exists = function (file) {
      return Control_Monad_Aff.makeAff(function (_0) {
          return function (a) {
...
(function(exports) {
  ...
  var unwrap = function (_35) {
      return _35.value0;
  };
  var toStr = function (_34) {
      return _34.value0;
  };
  ...
  var safeMkdir = function (f) {
      return Prelude[">>="](Control_Monad_Aff.bindAff)(Node_FS_Aff.exists(f))(function (doesExist) {
          ...
          throw new Error("Failed pattern match at App.Networking line 153, column 1 - line 154, column 1: " + [ _40.constructor.name ]);
      });
  };
  var rmdirRecur = function (d) {
      return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.exists(d))(function (_18) {
          var _42 = !_18;
          if (_42) {
              return Prelude["return"](Control_Monad_Aff.applicativeAff)(Prelude.unit);
          };
          if (!_42) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.readdir(d))(function (_17) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(function (f) {
                      return Node_FS_Aff.unlink(Node_Path.concat([ d, f ]));
                  })(_17))(function () {
                      return Node_FS_Aff.rmdir(d);
                  });
              });
          };
          throw new Error("Failed pattern match at App.Networking line 157, column 1 - line 158, column 1: " + [ _42.constructor.name ]);
      });
  };
  var overWriteFile = function (f) {
      return function (b) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.exists(f))(function (_19) {
              return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                  ...
                  throw new Error("Failed pattern match at App.Networking line 165, column 1 - line 166, column 1: " + [ _19.constructor.name ]);
              })())(function () {
  ...
  var isForeignWrappedId = new Data_Foreign_Class.IsForeign(function (obj) {
      return Prelude.bind(Data_Either.bindEither)(Data_Foreign_Class.readProp(Data_Foreign_Class.intIsForeign)(Data_Foreign_Index.indexString)("id")(obj))(function (_21) {
          return Prelude["return"](Data_Either.applicativeEither)(new WrappedId(_21));
      });
  });
  var isForeignNamedBuffer = new Data_Foreign_Class.IsForeign(function (obj) {
      return Prelude.bind(Data_Either.bindEither)(Data_Foreign_Class.readProp(Data_Foreign_Class.foreignIsForeign)(Data_Foreign_Index.indexString)("file")(obj))(function (_25) {
          return Prelude.bind(Data_Either.bindEither)(Data_Foreign_Class.readProp(Data_Foreign_Class.stringIsForeign)(Data_Foreign_Index.indexString)("name")(obj))(function (_24) {
              return Prelude["return"](Data_Either.applicativeEither)(NamedBuffer.create(_24)(Data_Foreign.unsafeFromForeign(_25)));
          });
      });
  });
  var isForeignLastUpdated = new Data_Foreign_Class.IsForeign(function (obj) {
      return Prelude.bind(Data_Either.bindEither)(Data_Foreign_Class.readProp(Data_Foreign_Class.stringIsForeign)(Data_Foreign_Index.indexString)("lastupdatedon")(obj))(function (_16) {
          return Prelude["return"](Data_Either.applicativeEither)(new LastUpdated(_16));
      });
  });
      ...
      return function (cname) {
          return function (profile) {
              return function (target) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint_(Data_Generic.genericUnit)(Data_Generic.genericArray(Data_Generic.genericString))(baseurl)(App_Endpoint.getProfileFiles)(new Data_Tuple.Tuple(cname, profile))(Prelude.unit))(function (_23) {
                      var makereq = function (fn) {
                          return {
                              headers: [  ], 
                      ...
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(function (filename) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableBuffer)(makereq(filename)))(function (_22) {
                              return Node_FS_Aff.writeFile(Node_Path.concat([ target, Node_Path.basename(filename) ]))(_22.response);
                          });
                      })(_23))(function () {
                          return Prelude["return"](Control_Monad_Aff.applicativeAff)(Prelude.unit);
                      });
  ...
  var downloadFileById = function (s) {
      return function (i) {
          ...
          return Prelude.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableBuffer)(req))(function (_26) {
              return Prelude["return"](Control_Monad_Aff.applicativeAff)(_26.response);
          });
      };
  };
  ...
  var copyDir = function (from) {
      return function (to) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(rmdirRecur(to))(function () {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.readdir(from))(function (_20) {
  ...
  var main = Control_Monad_Aff.runAff(function (_102) {
      return Control_Monad_Eff_Console.log(Prelude.show(Control_Monad_Eff_Exception.showError)(_102));
      ...
      return Prelude.bind(Control_Monad_Aff.bindAff)(App_DB.dropDB(conn))(function () {
          return Prelude.bind(Control_Monad_Aff.bindAff)(App_DB.makeDB(conn))(function () {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Initial SQL Done")))(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(App_DB.queryPhotobooth(conn)("mycomputername"))(function (_15) {
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint_(Data_Generic.genericUnit)(Data_Generic.genericMaybe(App_Model_Photobooth.genericPhotobooth))("http://localhost:8080")(App_Endpoint.getPhotobooth)("mycomputername")(Prelude.unit))(function (_14) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                              ...
                              if (_14 instanceof Data_Maybe.Just) {
                                  return Database_AnyDB.execute_(App_DB.upsertPB(_14.value0))(conn);
                              };
                              throw new Error("Failed pattern match at App.Networking line 46, column 1 - line 133, column 1: " + [ _14.constructor.name ]);
                          })())(function () {
                              return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                  var _61 = Prelude["/="](Data_Maybe.eqMaybe(App_Model_Photobooth.eqPhotobooth))(_15)(_14);
                                  if (_61) {
                                      return rmdirRecur(defaultDir);
                                  };
                                  if (!_61) {
                                      return Prelude["return"](Control_Monad_Aff.applicativeAff)(Prelude.unit);
                                  };
                                  throw new Error("Failed pattern match at App.Networking line 46, column 1 - line 133, column 1: " + [ _61.constructor.name ]);
                              })())(function () {
                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Synced Photobooth(s)")))(function () {
                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne(isForeignLastUpdated)(getLastUpdateEvents)([  ])(conn))(function (_13) {
                                          return Prelude.bind(Control_Monad_Aff.bindAff)(defaultDate(Control_Monad_Aff.monadErrorAff)(_13)(Data_Date.fromStringStrict("2010-01-01T00:00:00.000Z")))(function (_12) {
                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint_(Data_Generic.genericUnit)(Data_Generic.genericArray(App_Model_Event.genericPartialEvent))("http://localhost:8080")(App_Endpoint.getNewEvents)(new Data_Tuple.Tuple("mycomputername", _12))(Prelude.unit))(function (_11) {
                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(function (_27) {
                                                      if (_27.value0.id instanceof Data_Maybe.Just) {
                                                          return rmdirRecur(mkEventDir(_27.value0.id.value0));
                                                      };
                                                      throw new Error("Failed pattern match at App.Networking line 46, column 1 - line 133, column 1: " + [ _27.constructor.name ]);
                                                  })(_11))(function () {
                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB_Transaction.withTransaction(function (tc) {
                                                          ...
                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Synced Events")))(function () {
                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne(isForeignLastUpdated)(getLastUpdateFiles)([  ])(conn))(function (_10) {
                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(defaultDate(Control_Monad_Aff.monadErrorAff)(_10)(Data_Date.fromStringStrict("2010-01-01T00:00:00.000Z")))(function (_9) {
                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint_(Data_Generic.genericUnit)(Data_Generic.genericArray(App_Model_SavedFile.genericSavedFile))("http://localhost:8080")(App_Endpoint.getNewFiles)(new Data_Tuple.Tuple("mycomputername", _9))(Prelude.unit))(function (_8) {
                                                                          var eventIdsWithNewFiles = Prelude["<$>"](Prelude.functorArray)(function (_28) {
                                                                              return _28.value0.eventId;
                                                                          })(_8);
                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(function (i) {
                                                                              return rmdirRecur(mkEventDir(i));
                                                                              ...
                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB_Transaction.withTransaction(function (tc) {
                                                                                  ...
                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Synced Files")))(function () {
                                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query(isForeignWrappedId)(getEmptyFileEntries)([  ])(conn))(function (_7) {
                                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Prelude.flip(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff))(_7)(function (_29) {
                                                                                              return Prelude[">>="](Control_Monad_Aff.bindAff)(downloadFileById("http://localhost:8080")(_29.value0))(function (b) {
                                                                                                  return saveFile(conn)(_29.value0)(b);
                                                                                              });
                                                                                          }))(function () {
                                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Synced File contents")))(function () {
                                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(App_DB.queryAllStatistics(conn)("mycomputername"))(function (_6) {
                                                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint_(App_Model_Statistic.genericAllStatistics)(Data_Generic.genericUnit)("http://localhost:8080")(App_Endpoint.postStatistics)(Prelude.unit)(_6))(function () {
                                                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Synced statistics")))(function () {
                                                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.exists(defaultDir))(function (_5) {
                                                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                                                                                                      var _80 = !_5;
                                                                                                                      if (_80) {
                                                                                                                          if (_14 instanceof Data_Maybe.Nothing) {
                                                                                                                          ...
                                                                                                                          if (_14 instanceof Data_Maybe.Just) {
                                                                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.mkdir(defaultDir))(function () {
                                                                                                                                  return downloadFolder("http://localhost:8080")("mycomputername")(_14.value0.value0.defaultprofile)(defaultDir);
                                                                                                                              });
                                                                                                                          };
                                                                                                                      ...
                                                                                                                      throw new Error("Failed pattern match at App.Networking line 46, column 1 - line 133, column 1: " + [ _80.constructor.name ]);
                                                                                                                  })())(function () {
                                                                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(safeMkdir(Node_Path.normalize("clientprofiles")))(function () {
                                                                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query(App_Model_Event.partialEventIsForeign)(getEventsByCname)([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)("mycomputername") ])(conn))(function (_4) {
                                                                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Prelude["<$>"](Control_Monad_Aff.functorAff)(Data_Array.filter(function (s) {
                                                                                                                                  return Prelude["=="](Prelude.eqString)(Data_String.take(6)(s))("event_");
                                                                                                                              }))(Node_FS_Aff.readdir(Node_Path.normalize("clientprofiles"))))(function (_3) {
                                                                                                                                  var eventIdsFromFolders = Prelude["<$>"](Prelude.functorArray)(function (_103) {
                                                                                                                                      return (function (i) {
                                                                                                                                          return Data_Maybe.maybe(-1)(Prelude.id(Prelude.categoryFn))(App_DB.safeParseInt(i));
                                                                                                                                      })(Data_String.drop(6)(_103));
                                                                                                                                  })(_3);
                                                                                                                                  var missingEvents = Data_Array.filter(function (_30) {
                                                                                                                                      if (_30.value0.id instanceof Data_Maybe.Just) {
                                                                                                                                          return Data_Maybe.isNothing(Data_Array.elemIndex(Prelude.eqInt)(_30.value0.id.value0)(eventIdsFromFolders));
                                                                                                                                      };
                                                                                                                                      throw new Error("Failed pattern match at App.Networking line 109, column 9 - line 110, column 5: " + [ _30.constructor.name ]);
                                                                                                                                  })(_4);
                                                                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Making event folders for: " + Data_String.joinWith(", ")(Prelude["<$>"](Prelude.functorArray)(function (_31) {
                                                                                                                                      return _31.value0.name;
                                                                                                                                  })(missingEvents)))))(function () {
                                                                                                                                      return Prelude.flip(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff))(missingEvents)(function (_33) {
                                                                                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("No id for PartialEvent")))(Prelude["return"](Control_Monad_Aff.applicativeAff))(_33.value0.id))(function (_2) {
                                                                                                                                              var target = mkEventDir(_2);
                                                                                                                                              var temptarget = mkTempEventDir(_2);
                                                                                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(rmdirRecur(temptarget))(function () {
                                                                                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.mkdir(temptarget))(function () {
                                                                                                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(downloadFolder("http://localhost:8080")("mycomputername")(_33.value0.profile)(temptarget))(function () {
                                                                                                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(getFilesForEvent(conn)(_2))(function (_1) {
                                                                                                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Prelude.flip(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff))(_1)(function (_32) {
                                                                                                                                                                  return overWriteFile(Node_Path.concat([ temptarget, _32.value0 ]))(_32.value1);
                                                                                                                                                              }))(function () {
                                                                                                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.readdir(temptarget))(function (_0) {
                                                                                                                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(copyDir(temptarget)(target))(function () {
                                                                                                                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(rmdirRecur(temptarget))(function () {
                                                                                                                                                                              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Made folder for event " + Prelude.show(Prelude.showInt)(_2)));
                                                                                                                                                                          });
                                                                                                                                                                      });
                                                                                                                                                                  });
                                                                                                                                                              });
