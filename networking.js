...
(function(exports) {
  ...
  var rename = function (oldFile) {
      return function (newFile) {
          return function (cb) {
              return Node_FS_Internal.mkEff(function (_2) {
                  return $foreign.fs.rename(oldFile, newFile, handleCallback(cb));
              });
          };
      };
  };
...
(function(exports) {
  ...
  var unwrap = function (_26) {
      return _26.value0;
  };
  var toStr = function (_25) {
      return _25.value0;
  };
  ...
  var isForeignWrappedId = new Data_Foreign_Class.IsForeign(function (obj) {
      return Prelude.bind(Data_Either.bindEither)(Data_Foreign_Class.readProp(Data_Foreign_Class.intIsForeign)(Data_Foreign_Index.indexString)("id")(obj))(function (_14) {
          return Prelude["return"](Data_Either.applicativeEither)(new WrappedId(_14));
      });
  });
  var isForeignNamedBuffer = new Data_Foreign_Class.IsForeign(function (obj) {
      return Prelude.bind(Data_Either.bindEither)(Data_Foreign_Class.readProp(Data_Foreign_Class.foreignIsForeign)(Data_Foreign_Index.indexString)("file")(obj))(function (_18) {
          return Prelude.bind(Data_Either.bindEither)(Data_Foreign_Class.readProp(Data_Foreign_Class.stringIsForeign)(Data_Foreign_Index.indexString)("name")(obj))(function (_17) {
              return Prelude["return"](Data_Either.applicativeEither)(NamedBuffer.create(_17)(Data_Foreign.unsafeFromForeign(_18)));
          });
      });
  });
  var isForeignLastUpdated = new Data_Foreign_Class.IsForeign(function (obj) {
      return Prelude.bind(Data_Either.bindEither)(Data_Foreign_Class.readProp(Data_Foreign_Class.stringIsForeign)(Data_Foreign_Index.indexString)("lastupdatedon")(obj))(function (_13) {
          return Prelude["return"](Data_Either.applicativeEither)(new LastUpdated(_13));
      });
  });
  ...
  var getFilesForEvent = function (c) {
      return function (i) {
          return Database_AnyDB.query(isForeignNamedBuffer)("select file from files where eventid = ?")([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueInt)(i) ])(c);
      };
  };
  ...
  var downloadFolder = function (cname) {
      return function (profile) {
          return function (target) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint(Data_Generic.genericUnit)(Data_Generic.genericArray(Data_Generic.genericString))(App_Endpoint.getProfileFiles)(new Data_Tuple.Tuple(cname, profile))(Prelude.unit))(function (_16) {
                  ...
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(function (filename) {
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableBuffer)(makereq(filename)))(function (_15) {
                          return Node_FS_Aff.writeFile(Node_Path.concat([ target, filename ]))(_15.response);
                      });
                  })(_16))(function () {
  ...
  var downloadFileById = function (s) {
      return function (i) {
          ...
          return Prelude.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableBuffer)(req))(function (_19) {
              return Prelude["return"](Control_Monad_Aff.applicativeAff)(_19.response);
          });
      };
  };
  ...
  var main = Control_Monad_Aff.runAff(function (_71) {
      return Control_Monad_Eff_Console.log(Prelude.show(Control_Monad_Eff_Exception.showError)(_71));
      ...
      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Initial SQL Done")))(function () {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint_(Data_Generic.genericUnit)(Data_Generic.genericMaybe(App_Model_Photobooth.genericPhotobooth))("http://localhost:8080")(App_Endpoint.getPhotobooth)("mycomputername")(Prelude.unit))(function (_12) {
              return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                  ...
                  if (_12 instanceof Data_Maybe.Just) {
                      return Database_AnyDB.execute_(App_DB.upsertPB(_12.value0))(conn);
                  };
                  throw new Error("Failed pattern match at App.Networking line 49, column 1 - line 108, column 1: " + [ _12.constructor.name ]);
              })())(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Synced Photobooth(s)")))(function () {
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne(isForeignLastUpdated)(getLastUpdateEvents)([  ])(conn))(function (_11) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(defaultDate(Control_Monad_Aff.monadErrorAff)(_11)(Data_Date.fromStringStrict("2010-01-01T00:00:00.000Z")))(function (_10) {
                              return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint_(Data_Generic.genericUnit)(Data_Generic.genericArray(App_Model_Event.genericPartialEvent))("http://localhost:8080")(App_Endpoint.getNewEvents)(new Data_Tuple.Tuple("mycomputername", _10))(Prelude.unit))(function (_9) {
                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB_Transaction.withTransaction(function (tc) {
                                      ...
                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Synced Events")))(function () {
                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.queryOne(isForeignLastUpdated)(getLastUpdateFiles)([  ])(conn))(function (_8) {
                                              return Prelude.bind(Control_Monad_Aff.bindAff)(defaultDate(Control_Monad_Aff.monadErrorAff)(_8)(Data_Date.fromStringStrict("2010-01-01T00:00:00.000Z")))(function (_7) {
                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint_(Data_Generic.genericUnit)(Data_Generic.genericArray(App_Model_SavedFile.genericSavedFile))("http://localhost:8080")(App_Endpoint.getNewFiles)(new Data_Tuple.Tuple("mycomputername", _7))(Prelude.unit))(function (_6) {
                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB_Transaction.withTransaction(function (tc) {
                                                          ...
                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Synced Files")))(function () {
                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query(isForeignWrappedId)(getEmptyFileEntries)([  ])(conn))(function (_5) {
                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Prelude.flip(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff))(_5)(function (_20) {
                                                                      return Prelude[">>="](Control_Monad_Aff.bindAff)(downloadFileById("http://localhost:8080")(_20.value0))(function (b) {
                                                                          return saveFile(conn)(_20.value0)(b);
                                                                      });
                                                                  }))(function () {
                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Synced File contents")))(function () {
                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(App_DB.queryAllStatistics(conn)("mycomputername"))(function (_4) {
                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint_(App_Model_Statistic.genericAllStatistics)(Data_Generic.genericUnit)("http://localhost:8080")(App_Endpoint.postStatistics)(Prelude.unit)(_4))(function () {
                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Synced statistics")))(function () {
                                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Database_AnyDB.query(App_Model_Event.partialEventIsForeign)(getEventsByCname)([ Database_AnyDB_SqlValue.toSql(Database_AnyDB_SqlValue.isSqlValueString)("mycomputername") ])(conn))(function (_3) {
                                                                                          ...
                                                                                          }))(Node_FS_Aff.readdir(Node_Path.normalize("./clientprofiles"))))(function (_2) {
                                                                                              var eventIdsFromFolders = Prelude["<$>"](Prelude.functorArray)(function (_72) {
                                                                                                  return (function (i) {
                                                                                                      return Data_Maybe.maybe(-1)(Prelude.id(Prelude.categoryFn))(App_DB.safeParseInt(i));
                                                                                                  })(Data_String.drop(6)(_72));
                                                                                              })(_2);
                                                                                              var missingEvents = Data_Array.filter(function (_21) {
                                                                                                  if (_21.value0.id instanceof Data_Maybe.Just) {
                                                                                                      return Data_Maybe.isNothing(Data_Array.elemIndex(Prelude.eqInt)(_21.value0.id.value0)(eventIdsFromFolders));
                                                                                                  };
                                                                                                  throw new Error("Failed pattern match at App.Networking line 86, column 9 - line 87, column 5: " + [ _21.constructor.name ]);
                                                                                              })(_3);
                                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Making event folders for: " + Data_String.joinWith(", ")(Prelude["<$>"](Prelude.functorArray)(function (_73) {
                                                                                                  return Prelude.show(Prelude.showInt)((function (_22) {
                                                                                                      if (_22.value0.id instanceof Data_Maybe.Just) {
                                                                                                          return _22.value0.id.value0;
                                                                                                      };
                                                                                                      throw new Error("Failed pattern match at App.Networking line 49, column 1 - line 108, column 1: " + [ _22.constructor.name ]);
                                                                                                  })(_73));
                                                                                              })(missingEvents)))))(function () {
                                                                                                  return Prelude.flip(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff))(missingEvents)(function (_24) {
                                                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("No id for PartialEvent")))(Prelude["return"](Control_Monad_Aff.applicativeAff))(_24.value0.id))(function (_1) {
                                                                                                          var target = "event_" + Prelude.show(Prelude.showInt)(_1);
                                                                                                          var temptarget = target + "tmp";
                                                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.mkdir(Node_Path.concat([ "clientprofiles", temptarget ])))(function () {
                                                                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(downloadFolder("mycomputername")(_24.value0.profile)(temptarget))(function () {
                                                                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(getFilesForEvent(conn)(_1))(function (_0) {
                                                                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Prelude.flip(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff))(_0)(function (_23) {
                                                                                                                          return Node_FS_Aff.writeFile(Node_Path.concat([ temptarget, _23.value0 ]))(_23.value1);
                                                                                                                      }))(function () {
                                                                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.rename(temptarget)(target))(function () {
                                                                                                                              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Made folder for event " + Prelude.show(Prelude.showInt)(_1)));
                                                                                                                          });
                                                                                                                      });
                                                                                                                  });
                                                                                                              });
