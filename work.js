                      ...
                      return function (okcb) {
                          ...
                          var handler = function (v) {
                              if (v.error instanceof Data_Maybe.Just) {
                                  return errcb(v.error.value0);
                              };
                              return function __do() {
                                  var s = Node_Buffer.size(v.stderr)();
                                  var $4 = s > 0;
                                  if ($4) {
                                      var err = Node_Buffer.toString(Node_Encoding.UTF8.value)(v.stderr)();
                                      return errcb(Control_Monad_Eff_Exception.error(err))();
                                  };
                                  if (!$4) {
                                      var res = Node_Buffer.toString(Node_Encoding.UTF8.value)(v.stdout)();
                                      return okcb(res)();
                                  };
                                  throw new Error("Failed pattern match at App.Exec line 33, column 29 - line 36, column 67: " + [ $4.constructor.name ]);
                              };
                          };
...
(function(exports) {
  ...
  var startPrograms = function (v) {
      return Prelude.bind(Control_Monad_Aff.bindAff)(App_Exec.simpleExec("logman")(Data_Maybe.Nothing.value)([ "start Prints" ])(Data_Maybe.Nothing.value))(function () {
          return App_Exec.simpleExec("start")(Data_Maybe.Nothing.value)([ v.value0.photoProgramFullPath ])(Data_Maybe.Nothing.value);
      });
  };
  ...
  var mkDirForActive = function (v) {
      if (v instanceof App_Model_WorkerState.DefaultActive) {
          return Node_Path.concat([ mainPhotosDir, "default" ]);
      };
      ...
      throw new Error("Failed pattern match at App.Worker line 212, column 1 - line 213, column 1: " + [ v.constructor.name ]);
  };
          ...
          return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("No printer log files found in " + fp)))(Prelude["return"](Control_Monad_Aff.applicativeAff))(Data_Array.last(v)))(function (v1) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(Node_Path.concat([ fp, v1 ])))(function (v2) {
                  ...
                  if ($38 instanceof Data_Maybe.Just) {
                      ...
                      throw new Error("Failed pattern match at App.Worker line 179, column 10 - line 188, column 1: " + [ $39.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at App.Worker line 176, column 3 - line 188, column 1: " + [ $38.constructor.name ]);
              });
          });
      });
  };
  var killPrograms = function (v) {
      return Prelude.bind(Control_Monad_Aff.bindAff)(App_Exec.simpleExec("taskkill")(Data_Maybe.Nothing.value)([ "/F", "/IM", v.value0.photoProgramExe ])(Data_Maybe.Nothing.value))(function () {
                                              ...
                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.readdir(printsdir))(function (v1) {
                                                  ...
                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Prelude["return"](Control_Monad_Aff.applicativeAff)(0))(function (d) {
                                                      ...
                                                      return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                                          ...
                                                          throw new Error("Failed pattern match at App.Worker line 113, column 17 - line 118, column 3: " + [ lastphotosdir.constructor.name ]);
                                                      })())(function (v3) {
                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Prelude["<$>"](Control_Monad_Eff.functorEff)(App_Model_Statistic.monthToInt)(Data_Date_Locale.month(dateNow))))(function (v4) {
                                                              return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                                                  ...
                                                                  throw new Error("Failed pattern match at App.Worker line 119, column 3 - line 133, column 3: " + [ old.constructor.name ]);
                                                              })())(function () {
      ...
      return function (end) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.exists(end))(function (v) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Prelude[">>="](Control_Monad_Aff.bindAff)(Node_FS_Aff.stat(start))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at App.Worker line 205, column 3 - line 208, column 1: " + [ $70.constructor.name ]);
              });
          });
      };
  };
  var main = Control_Monad_Aff.runAff(function ($97) {
      return Control_Monad_Eff_Console.log(Prelude.show(Control_Monad_Eff_Exception.showError)($97));
      ...
      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Node_OS.hostname))(function (v) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(App_Config.readConfigFile))(function (v1) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Either.either(function ($98) {
                  return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error(Prelude.show(Data_Foreign.showForeignError)($98)));
                                                              ...
                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Date.now))(function (v7) {
                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(App_DB.queryActiveEvent(conn)(v7))(function (v8) {
                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                                                          ...
                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                                                              var $94 = Prelude["/="](App_Model_WorkerState.eqActive)(v9)(v4.value0.active);
                                                                              if ($94) {
                                                                              ...
                                                                              throw new Error("Failed pattern match at App.Worker line 84, column 34 - line 87, column 3: " + [ $94.constructor.name ]);
                                                                          })())(function () {
                                                                              return Prelude["return"](Control_Monad_Aff.applicativeAff)(Prelude.unit);
                                                                          });
                                                                      });
