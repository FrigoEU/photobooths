      ...
      return function (c) {
          return function (m) {
              var handle = function (v) {
                  ...
                  throw new Error("Failed pattern match at App.DB line 351, column 3 - line 359, column 1: " + [ v.constructor.name ]);
              };
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];        
  var simpleExecStr = function (cmd) {
      return function (cwd) {
          return function (env) {
              return Control_Monad_Aff.makeAff(function (errcb) {
                  return function (okcb) {
                      var ops = {
                          cwd: cwd, 
                          env: env, 
                          timeout: new Data_Maybe.Just(5000.0), 
                      ...
                      var handler = function (v) {
                          return function __do() {
                              ...
                              return Data_Maybe.maybe(okcb(Data_String.joinWith(" ")([ "Success:", cmd, "Stdout:", v2, "StdErr: ", v1 ])))(function (e) {
                                  return errcb(Control_Monad_Eff_Exception.error(Data_String.joinWith(" ")([ "Error:", cmd, "Stdout:", v2, "StdErr: ", v1, "Error:", Prelude.show(Control_Monad_Eff_Exception.showError)(e) ])));
                              })(v.error)();
                          };
                      };
                      return Node_ChildProcess.exec(cmd)(ops)(handler);
                  };
              });
          };
      };
  ...
  exports["simpleExecStr"] = simpleExecStr;
...
(function(exports) {
  ...
  var startPrograms = function (v) {
      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.apathize(App_Exec.simpleExecStr("logman start Prints")(Data_Maybe.Nothing.value)(Data_Maybe.Nothing.value)))(function () {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.apathize(App_Exec.simpleExec("taskkill")(Data_Maybe.Nothing.value)([ "/F", "/IM", v.value0.photoProgramExe ])(Data_Maybe.Nothing.value)))(function () {
              return Prelude.bind(Control_Monad_Aff.bindAff)(App_Exec.simpleExecStr("start " + v.value0.photoProgramFullPath)(Data_Maybe.Nothing.value)(Data_Maybe.Nothing.value))(function () {
      ...
      return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.readdir(fp))(function (v) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("No printer log files found in " + fp)))(Prelude["return"](Control_Monad_Aff.applicativeAff))(Data_Array.last(v)))(function (v1) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(Node_Path.concat([ fp, v1 ])))(function (v2) {
                  var $35 = Data_String_Regex.match(lastNumber)(v2);
                  ...
                  if ($35 instanceof Data_Maybe.Just) {
                      ...
                      if ($36 instanceof Data_Maybe.Just && $36.value0 instanceof Data_Maybe.Nothing) {
                      ...
                      if ($36 instanceof Data_Maybe.Just && $36.value0 instanceof Data_Maybe.Just) {
                          return Data_Maybe.maybe(Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("Couldn't parse " + ($36.value0.value0 + (" in " + v1)))))(Prelude["return"](Control_Monad_Aff.applicativeAff))(Data_Int_Extended.safeParseInt($36.value0.value0));
                      };
                      throw new Error("Failed pattern match at App.Worker line 180, column 10 - line 189, column 1: " + [ $36.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at App.Worker line 177, column 3 - line 189, column 1: " + [ $35.constructor.name ]);
              });
          });
      });
  };
  var killPrograms = function (v) {
      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.apathize(App_Exec.simpleExec("taskkill")(Data_Maybe.Nothing.value)([ "/F", "/IM", v.value0.photoProgramExe ])(Data_Maybe.Nothing.value)))(function () {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.apathize(App_Exec.simpleExecStr("logman stop Prints")(Data_Maybe.Nothing.value)(Data_Maybe.Nothing.value)))(function () {
              return Prelude.pure(Control_Monad_Aff.applicativeAff)(Prelude.unit);
          });
      });
  };
  ...
  var mkHistoryDirForActive = function (v) {
      ...
      throw new Error("Failed pattern match at App.Worker line 216, column 1 - line 217, column 1: " + [ v.constructor.name ]);
  };
                                                  ...
                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.readdir(printsdir))(function (v1) {
                                                      ...
                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Prelude["return"](Control_Monad_Aff.applicativeAff)(0))(function (d) {
                                                          ...
                                                          return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                                              ...
                                                              throw new Error("Failed pattern match at App.Worker line 114, column 17 - line 119, column 3: " + [ lastprintsdir.constructor.name ]);
                                                          })())(function (v3) {
                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Prelude["<$>"](Control_Monad_Eff.functorEff)(App_Model_Statistic.monthToInt)(Data_Date_Locale.month(dateNow))))(function (v4) {
                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                                                      if (old instanceof App_Model_WorkerState.DefaultActive) {
                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)(App_DB.getMonthlyStatistic(cname)(conn)(v4))(function (v5) {
                                                                              var q = App_DB.upsertMonthlyStatistic(new App_Model_Statistic.MonthlyStatistic((function () {
                                                                                  var $56 = {};
                                                                                  for (var $57 in v5.value0) {
                                                                                      if (v5.value0.hasOwnProperty($57)) {
                                                                                          $56[$57] = v5.value0[$57];
                                                                                      };
                                                                                  };
                                                                                  $56.pictures = v5.value0.pictures + amountOfPhotosTakenInOld | 0;
                                                                                  $56.prints = v5.value0.prints + v3 | 0;
                                                                                  return $56;
                                                                              })()));
                                                                      ...
                                                                      throw new Error("Failed pattern match at App.Worker line 120, column 3 - line 134, column 3: " + [ old.constructor.name ]);
                                                                  })())(function () {
                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Prelude["return"](Control_Monad_Aff.applicativeAff)(Prelude.unit))(App_FS.rmdirRecur)(secondtolastprintsfolders))(function () {
                                                                          var sourcedir = (function () {
                                                                              ...
                                                                              throw new Error("Failed pattern match at App.Worker line 137, column 19 - line 140, column 3: " + [ $$new.constructor.name ]);
                                                                          })();
      ...
      return function (end) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.exists(end))(function (v) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Prelude[">>="](Control_Monad_Aff.bindAff)(Node_FS_Aff.stat(start))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at App.Worker line 209, column 3 - line 212, column 1: " + [ $68.constructor.name ]);
              });
          });
      };
  };
  var main = Control_Monad_Aff.runAff(function ($95) {
      return Control_Monad_Eff_Console.log(Prelude.show(Control_Monad_Eff_Exception.showError)($95));
      ...
      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Node_OS.hostname))(function (v) {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(App_Config.readConfigFile))(function (v1) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Either.either(function ($96) {
                  return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error(Prelude.show(Data_Foreign.showForeignError)($96)));
                                                              ...
                                                              return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Date.now))(function (v7) {
                                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(App_DB.queryActiveEvent(conn)(v7))(function (v8) {
                                                                      return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                                                          ...
                                                                          throw new Error("Failed pattern match at App.Worker line 79, column 16 - line 83, column 3: " + [ v8.constructor.name ]);
                                                                      })())(function (v9) {
                                                                          return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                                                              var $92 = Prelude["/="](App_Model_WorkerState.eqActive)(v9)(v4.value0.active);
                                                                              if ($92) {
                                                                              ...
                                                                              throw new Error("Failed pattern match at App.Worker line 84, column 34 - line 87, column 3: " + [ $92.constructor.name ]);
                                                                          })())(function () {
                                                                              return Prelude["return"](Control_Monad_Aff.applicativeAff)(Prelude.unit);
                                                                          });
                                                                      });
