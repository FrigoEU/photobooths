...
(function(exports) {
  ...
  var nav = function (s) {
      return function (h) {
          return function (_0) {
              if (_0 instanceof App_Client_State.PhotoboothsPage) {
                  return function __do() {
                      $foreign.setHash("/photobooths")();
                      return OpticUI_Core.runHandler(h)(Data_Lens_Setter.set(App_Client_State._route(Data_Profunctor_Strong.strongFn))(_0)(s))();
                  };
              };
              if (_0 instanceof App_Client_State.EventsPage) {
                  return function __do() {
                      $foreign.setHash("/events/" + _0.value0)();
                      return OpticUI_Core.runHandler(h)(Data_Lens_Setter.set(App_Client_State._route(Data_Profunctor_Strong.strongFn))(_0)(s))();
                  };
              };
              throw new Error("Failed pattern match at App.Client.Router line 23, column 1 - line 24, column 1: " + [ s.constructor.name, h.constructor.name, _0.constructor.name ]);
          };
      };
  };
  var match$prime = function (str) {
      ...
      throw new Error("Failed pattern match at App.Client.Router line 34, column 1 - line 35, column 1: " + [ _5.constructor.name ]);
  };
...
(function(exports) {
          ...
          return function (i) {
              if (_9 instanceof Data_Maybe.Just && i === _9.value0) {
                  return OpticUI_Core["with"](function (_5) {
                      return function (h) {
                          return OpticUI_Core.withView(OpticUI_Markup_HTML.tr([  ]))(Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ OpticUI_Core.ui(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(_5.value0.computername))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Model_Photobooth._Photobooth(OpticUI_Core.uiStrong)(App_Client_State._alias(OpticUI_Core.uiStrong)(OpticUI_Components.textField([ OpticUI_Markup_HTML.classA("form-control") ])))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Model_Photobooth._Photobooth(OpticUI_Core.uiStrong)(App_Client_State._defaultprofile(OpticUI_Core.uiStrong)(OpticUI_Components.textField([ OpticUI_Markup_HTML.classA("form-control") ])))), OpticUI_Core.ui(OpticUI_Markup_HTML.td([  ])(Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Markup.markupMonoid)([ OpticUI_Markup_HTML.button([ OpticUI_Markup_HTML.classA("btn btn-warning"), OpticUI_Markup_HTML.onClick(function (_3) {
      ...
      return OpticUI_Core["with"](function ($$new) {
          return function (h) {
              return Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ App_Model_Async._Initial(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(OpticUI_Core.ui(OpticUI_Markup_HTML.button([ OpticUI_Markup_HTML.classA("btn btn-primary"), OpticUI_Markup_HTML.onClick(function (_0) {
                  ...
                  return handle(Crud.create(App_Client_Views_Crud.NewSaveFailed.create(_29)));
  ...
  var makeNewPb = function (handle) {
      return OpticUI_Core["with"](function (model) {
          return function (h) {
              return OpticUI_Core.withView(OpticUI_Markup_HTML.tr([  ]))(Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Client_State._model(OpticUI_Core.uiStrong)(App_Client_State._computername(OpticUI_Core.uiStrong)(OpticUI_Components.textField([ OpticUI_Markup_HTML.classA("form-control") ])))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Client_State._model(OpticUI_Core.uiStrong)(App_Client_State._alias(OpticUI_Core.uiStrong)(OpticUI_Components.textField([ OpticUI_Markup_HTML.classA("form-control") ])))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Client_State._model(OpticUI_Core.uiStrong)(App_Client_State._defaultprofile(OpticUI_Core.uiStrong)(OpticUI_Components.textField([ OpticUI_Markup_HTML.classA("form-control") ])))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Client_State._state(OpticUI_Core.uiStrong)(makeNewPbButton(handle))) ]));
          };
      });
  };
          ...
          return Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ App_Client_State._collection(OpticUI_Core.uiStrong)(OpticUI_Core["with"](function (pbs) {
              return function (h) {
                  return Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ App_Model_Async._Initial(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(App_Client_Components_Exec.exec(OpticUI_Markup.markupMonoid)(handle(new Crud(App_Client_Views_Crud.LoadAll.value))))(OpticUI_Core.ui(OpticUI_Markup_HTML.tr([  ])(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text("Nothing loaded yet")))))), App_Model_Async._Busy(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ OpticUI_Core.ui(OpticUI_Markup_HTML.tr([  ])(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text("Loading photobooths")))), OpticUI_Components_Async.onResult(OpticUI_Markup.markupMonoid)(function (_30) {
                      return handle(Crud.create(App_Client_Views_Crud.Loaded.create(_30)));
                  })(function (_31) {
                      return handle(Crud.create(App_Client_Views_Crud.LoadingFailed.create(_31)));
                  }) ])), App_Model_Async._Done(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(OpticUI_Core.foreach(OpticUI_Markup.markupMonoid)(Data_Traversable.traversableArray)(showPB(handle)(selInd))), App_Model_Async._Errored(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(OpticUI_Core["with"](function (err) {
                      return function (_2) {
              ...
              return handle(Crud.create(App_Client_Views_Crud.EditSaveFailed.create(_32)));
          ...
          return function (h) {
              ...
              var handle = function (_10) {
                  if (_10 instanceof Crud) {
                      return App_Client_Views_Crud.crudHandler(s)(h)(impls)(_10.value0);
                  };
                  if (_10 instanceof ToEvents) {
                      return $$goto(new App_Client_State.EventsPage(_10.value0));
                  };
                  throw new Error("Failed pattern match at App.Client.Views.PhotoboothsPage line 42, column 1 - line 48, column 1: " + [ _10.constructor.name ]);
              };
              ...
              }))), App_Client_State._new(OpticUI_Core.uiStrong)(makeNewPb(handle)) ]));
          };
      });
  };
  exports["photoboothsPage"] = photoboothsPage;;
...
(function(exports) {
  ...
  var newEventButton = function (handle) {
      var c = function (_17) {
          return function (h) {
              if (_17 instanceof App_Model_Async.Busy) {
                  return Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(OpticUI_Core.ui(OpticUI_Markup_HTML.button([ OpticUI_Markup_HTML.classA("btn btn-warning") ])(OpticUI_Markup.text("Saving Event"))))(App_Model_Async._Busy(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(OpticUI_Components_Async.onResult(OpticUI_Markup.markupMonoid)(function (_85) {
                      return handle(Crud.create(App_Client_Views_Crud.NewSaved.create(_85)));
                  })(function (_86) {
                      return handle(Crud.create(App_Client_Views_Crud.NewSaveFailed.create(_86)));
                  })));
              };
              if (_17 instanceof App_Model_Async.Errored) {
      ...
      return function (i) {
          return function (editing) {
              var c = function (_16) {
                  ...
                  if (_16 instanceof Data_Maybe.Just && _16.value0.saving instanceof App_Model_Async.Busy) {
                      return OpticUI_Core.ui(OpticUI_Markup_HTML.button([ OpticUI_Markup_HTML.classA("btn btn-warning") ])(OpticUI_Markup.text("Saving")));
                  };
                  if (_16 instanceof Data_Maybe.Just && _16.value0.saving instanceof App_Model_Async.Errored) {
                  ...
                  throw new Error("Failed pattern match at App.Client.Views.EventsPage line 118, column 5 - line 119, column 5: " + [ _16.constructor.name ]);
              };
              return c(editing);
          };
      };
  ...
  var showEvents = function (handle) {
                      ...
                      return function (h) {
                          ...
                          var fileSelected = function (_14) {
                              return function (_15) {
                                      ...
                                      return function __do() {
                                          ...
                                          return OpticUI_Core.runHandler(h)((function () {
                                              ...
                                              _54.state = (function () {
                                                  ...
                                                  _52.savingImage = new App_Model_Async.Busy(a);
                                                  return _52;
                                              })();
                                              return _54;
                                          })())();
                                  ...
                                  throw new Error("Failed pattern match at App.Client.Views.EventsPage line 99, column 11 - line 100, column 8: " + [ _14.constructor.name, _15.constructor.name ]);
                              };
                          };
                          var fileSaved = function (si) {
                              return OpticUI_Core.runHandler(h)({
                                  model: Data_Lens_Setter.over(function (_87) {
                                      return App_Model_Event._Event(Data_Profunctor_Strong.strongFn)(App_Client_State._images(Data_Profunctor_Strong.strongFn)(_87));
                                  ...
                                  state: (function () {
                                      ...
                                      _57.savingImage = App_Model_Async.Initial.value;
                          ...
                          var fileSaveErrored = function (err) {
                              return OpticUI_Core.runHandler(h)((function () {
                                  ...
                                  _61.state = (function () {
                                      ...
                                      _59.savingImage = new App_Model_Async.Errored(err);
                                      return _59;
                                  })();
                                  return _61;
                              })());
                          };
                          return Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ OpticUI_Core.ui(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(Data_Maybe.maybe("")(Prelude.show(Prelude.showInt))(_13.model.value0.id)))), OpticUI_Core.ui(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(_13.model.value0.computername))), OpticUI_Core.ui(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(_13.model.value0.name))), OpticUI_Core.ui(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(App_Model_Date.iso8601(_13.model.value0.datefrom)))), OpticUI_Core.ui(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(App_Model_Date.iso8601(_13.model.value0.dateuntil)))), OpticUI_Core.ui(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(_13.model.value0.profile))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(editEventButton(handle)(i)(editing)), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ App_Client_State._state(OpticUI_Core.uiStrong)(App_Client_State._image(OpticUI_Core.uiStrong)(App_Client_Components_FileInput.fileInput([ App_Client_Components_FileInput.onFileInput(fileSelected), App_Client_Components_FileInput.accept(".jpg,.jpeg") ]))), App_Client_State._model(OpticUI_Core.uiStrong)(App_Model_Event._Event(OpticUI_Core.uiStrong)(App_Client_State._images(OpticUI_Core.uiStrong)(OpticUI_Core.traversal(OpticUI_Markup.markupMonoid)(function (__dict_Wander_0) {
      ...
      var c = function (_11) {
          return function (h) {
              ...
              if (_11.collection instanceof App_Model_Async.Done) {
                  var selI = Data_Maybe.maybe(Data_Maybe.Nothing.value)(function (ed) {
                      return new Data_Maybe.Just(ed.index);
                  })(_11.editing);
                  var editing = Data_Lens_Getter.view(App_Client_State._editing(Data_Profunctor_Star.strongStar(Data_Const.functorConst)))(_11);
              ...
              throw new Error("Failed pattern match at App.Client.Views.EventsPage line 70, column 1 - line 74, column 1: " + [ _11.constructor.name, h.constructor.name ]);
          };
      };
      return Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(OpticUI_Core["with"](c))(Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(App_Client_State._collection(OpticUI_Core.uiStrong)(App_Model_Async._Initial(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(App_Client_Components_Exec.exec(OpticUI_Markup.markupMonoid)(handle(new Crud(App_Client_Views_Crud.LoadAll.value))))))(Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(App_Client_State._collection(OpticUI_Core.uiStrong)(App_Model_Async._Busy(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(OpticUI_Components_Async.onResult(OpticUI_Markup.markupMonoid)(function (_88) {
          return handle(Crud.create(App_Client_Views_Crud.Loaded.create(_88)));
      })(function (_89) {
          return handle(Crud.create(App_Client_Views_Crud.LoadingFailed.create(_89)));
      }))))(App_Client_State._editing(OpticUI_Core.uiStrong)(Data_Lens_Prism_Maybe._Just(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(App_Client_State._saving(OpticUI_Core.uiStrong)(App_Model_Async._Busy(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(OpticUI_Components_Async.onResult(OpticUI_Markup.markupMonoid)(function (_90) {
          return handle(Crud.create(App_Client_Views_Crud.EditSaved.create(_90)));
      })(function (_91) {
          return handle(Crud.create(App_Client_Views_Crud.EditSaveFailed.create(_91)));
      }))))))));
  };
  var eventsPage = function (cn) {
      var c = function (_9) {
          return function (h) {
              if (_9.route instanceof App_Client_State.EventsPage) {
                  var impls = {
                  ...
                  var handle = function (_10) {
                      return App_Client_Views_Crud.crudHandler(_9)(h)(impls)(_10.value0);
                  };
                  ...
                  })(Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(App_Client_State._collectionEditing(OpticUI_Core.uiStrong)(showEvents(handle)))(App_Client_State._new(OpticUI_Core.uiStrong)(makeNewEvent(handle)))) ]));
              };
...
(function(exports) {
  ...
  var main = function __do() {
      ...
      var _1 = App_Client_State.initialState(_2)();
      var _0 = OpticUI_Run.animate(_1)(OpticUI_Core["with"](function (s) {
          return function (h) {
              var nav$prime = App_Client_Router.nav(s)(h);
              var _5 = Data_Lens_Getter.view(App_Client_State._route(Data_Profunctor_Star.strongStar(Data_Const.functorConst)))(s);
              if (_5 instanceof App_Client_State.PhotoboothsPage) {
                  return App_Client_State._pbPage(OpticUI_Core.uiStrong)(App_Client_Views_PhotoboothsPage.photoboothsPage(nav$prime));
              };
              if (_5 instanceof App_Client_State.EventsPage) {
                  return App_Client_State._eventsPage(OpticUI_Core.uiStrong)(App_Client_Views_EventsPage.eventsPage(_5.value0));
              };
              throw new Error("Failed pattern match at App.Client line 18, column 1 - line 19, column 1: " + [ _5.constructor.name ]);
          };
      }))();
      return App_Client_Router.hashChanged(function (str) {
          return _0(function (s) {
              return Data_Lens_Setter.set(App_Client_State._route(Data_Profunctor_Strong.strongFn))(App_Client_Router.match(str))(s);
          });
      })();
  };
  exports["main"] = main;;
