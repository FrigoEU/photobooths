...
(function(exports) {
  ...
  var any = function (__dict_Foldable_32) {
      return function (__dict_BooleanAlgebra_33) {
          return function (p) {
              return function (_100) {
                  return Data_Monoid_Disj.runDisj(foldMap(__dict_Foldable_32)(Data_Monoid_Disj.monoidDisj(__dict_BooleanAlgebra_33))(function (_101) {
                      return Data_Monoid_Disj.Disj(p(_101));
                  })(_100));
              };
          };
      };
...
})(PS["App.Client.Router"] = PS["App.Client.Router"] || {});
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var Prelude = PS["Prelude"];
...
})(PS["App.Client.State"] = PS["App.Client.State"] || {});
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var Prelude = PS["Prelude"];
...
(function(exports) {
  ...
  var App_Model_Statistic = PS["App.Model.Statistic"];
  var App_Model_Async = PS["App.Model.Async"];
  var App_Client_State = PS["App.Client.State"];
  var App_Client_Types = PS["App.Client.Types"];
...
})(PS["App.Client.Load"] = PS["App.Client.Load"] || {});
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var $foreign = PS["App.Client.Router"];
  var OpticUI_Core = PS["OpticUI.Core"];
  ...
  var App_Model_Async = PS["App.Model.Async"];
  var App_Client_State = PS["App.Client.State"];
  var App_Client_Load = PS["App.Client.Load"];
  var App_Client_Types = PS["App.Client.Types"];
  var Data_Profunctor_Strong = PS["Data.Profunctor.Strong"];     
  var nav_ = function (s) {
      return function (_4) {
          if (_4 instanceof App_Client_State.PhotoboothsPage) {
              return Prelude["return"](Control_Monad_Eff.applicativeEff)(new Data_Tuple.Tuple("/photobooths", Data_Lens_Setter.set(App_Client_State._route(Data_Profunctor_Strong.strongFn))(_4)(s)));
          };
          if (_4 instanceof App_Client_State.EventsPage) {
              return function __do() {
                  var _0 = OpticUI_Components_Async.async(App_Client_Load.loadEvents(_4.value0))();
                  return (function () {
                      var modifications = function (_18) {
                          return Data_Lens_Setter.set(App_Client_State._route(Data_Profunctor_Strong.strongFn))(_4)(Data_Lens_Setter.set(App_Client_State._events(Data_Profunctor_Strong.strongFn))(new App_Model_Async.Busy(_0))(_18));
                      };
                      return Prelude["return"](Control_Monad_Eff.applicativeEff)(new Data_Tuple.Tuple("/events/" + _4.value0, modifications(s)));
                  })()();
              };
          };
          if (_4 instanceof App_Client_State.StatisticsPage) {
              return function __do() {
                  var _2 = OpticUI_Components_Async.async(App_Client_Load.loadEvents(_4.value0))();
                  var _1 = OpticUI_Components_Async.async(App_Client_Load.loadStatistics(_4.value0))();
                  return (function () {
                      var modifications = function (_19) {
                          return Data_Lens_Setter.set(App_Client_State._route(Data_Profunctor_Strong.strongFn))(_4)(Data_Lens_Setter.set(App_Client_State._events(Data_Profunctor_Strong.strongFn))(new App_Model_Async.Busy(_2))(Data_Lens_Setter.set(App_Client_State._statistics(Data_Profunctor_Strong.strongFn))(new App_Model_Async.Busy(_1))(_19)));
                      };
                      return Prelude["return"](Control_Monad_Eff.applicativeEff)(new Data_Tuple.Tuple("/statistics/" + _4.value0, modifications(s)));
                  })()();
              };
          };
          throw new Error("Failed pattern match at App.Client.Router line 37, column 1 - line 38, column 1: " + [ s.constructor.name, _4.constructor.name ]);
      };
  };
  var nav = function (s) {
      return function (h) {
  ...
  var match$prime = function (str) {
      ...
      if (_15) {
          return new Data_Maybe.Just(App_Client_State.PhotoboothsPage.value);
      };
      if (!_15) {
          var _16 = Prelude["=="](Prelude.eqString)(Data_String.take(6)(t))("events");
          if (_16) {
              return new Data_Maybe.Just(new App_Client_State.EventsPage(Data_String.drop(7)(t)));
          };
          if (!_16) {
              var _17 = Prelude["=="](Prelude.eqString)(Data_String.take(10)(t))("statistics");
              if (_17) {
                  return new Data_Maybe.Just(new App_Client_State.StatisticsPage(Data_String.drop(11)(t)));
              };
              if (!_17) {
                  return Data_Maybe.Nothing.value;
              };
      ...
      throw new Error("Failed pattern match at App.Client.Router line 55, column 1 - line 56, column 1: " + [ _15.constructor.name ]);
  };
  var match = function (str) {
      return Data_Maybe.maybe(App_Client_State.PhotoboothsPage.value)(Prelude.id(Prelude.categoryFn))(match$prime(str));
  };
  exports["match"] = match;
  exports["nav_"] = nav_;
  exports["nav"] = nav;
...
})(PS["App.Client.Components.Exec"] = PS["App.Client.Components.Exec"] || {});
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var OpticUI_Core = PS["OpticUI.Core"];
              ...
              return OpticUI_Core["with"](function (s) {
                  return function (h) {
                      ...
                      var options = (function () {
                          ...
                          throw new Error("Failed pattern match at App.Client.Components.Select line 12, column 1 - line 13, column 1: " + [ _2.constructor.name ]);
                      })();
                      var handler = function (_0) {
                          return function (_1) {
                              ...
                              throw new Error("Failed pattern match at App.Client.Components.Select line 12, column 1 - line 13, column 1: " + [ _0.constructor.name, _1.constructor.name ]);
                          };
                      };
...
})(PS["App.Client.Components.Select"] = PS["App.Client.Components.Select"] || {});
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var Data_Lens_Setter = PS["Data.Lens.Setter"];
                  ...
                  var updateEditingAndStop = function (replacement) {
                      return Data_Maybe.maybe(Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit))(function (_1) {
                          var updates = function (_21) {
                              return Data_Lens_Setter.set(App_Client_State._editing(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value)(Data_Lens_Setter.over(function (_22) {
                                  return App_Client_State._collection(Data_Profunctor_Strong.strongFn)(App_Model_Async._Done(Data_Profunctor_Choice.choiceFn)(_22));
                              })(function (as) {
                      ...
                      })(Data_Lens_Getter.view(App_Client_State._editing(Data_Profunctor_Star.strongStar(Data_Const.functorConst)))(s));
                  };
                  var handle = function (_4) {
                      if (_4 instanceof LoadAll) {
                          return function __do() {
                              var a = OpticUI_Components_Async.async(impls.loadAll)();
                              return OpticUI_Core.runHandler(h)(Data_Lens_Setter.set(App_Client_State._collection(Data_Profunctor_Strong.strongFn))(new App_Model_Async.Busy(a))(s))();
                          };
                      };
                      if (_4 instanceof SaveNew) {
                          return function __do() {
                              var a = OpticUI_Components_Async.async(impls.saveNew(impls.constr(Data_Lens_Getter.view(function (_23) {
                                  return App_Client_State._new(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(App_Client_State._model(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(_23));
                              })(s))))();
                              return OpticUI_Core.runHandler(h)(Data_Lens_Setter.set(function (_24) {
                                  return App_Client_State._new(Data_Profunctor_Strong.strongFn)(App_Client_State._state(Data_Profunctor_Strong.strongFn)(_24));
                              })(new App_Model_Async.Busy(a))(s))();
                          };
                      };
                      if (_4 instanceof Loaded) {
                          return OpticUI_Core.runHandler(h)(Data_Lens_Setter.set(App_Client_State._collection(Data_Profunctor_Strong.strongFn))(new App_Model_Async.Done(_4.value0))(s));
                      };
                      if (_4 instanceof LoadingFailed) {
                          return OpticUI_Core.runHandler(h)(Data_Lens_Setter.set(App_Client_State._collection(Data_Profunctor_Strong.strongFn))(new App_Model_Async.Errored(_4.value0))(s));
                      };
                      if (_4 instanceof NewSaveFailed) {
                          return OpticUI_Core.runHandler(h)(Data_Lens_Setter.set(function (_25) {
                              return App_Client_State._new(Data_Profunctor_Strong.strongFn)(App_Client_State._state(Data_Profunctor_Strong.strongFn)(_25));
                          ...
                          var updates = function (init) {
                              return function (_26) {
                                  return Data_Lens_Setter.over(function (_27) {
                                      return App_Client_State._collection(Data_Profunctor_Strong.strongFn)(App_Model_Async._Done(Data_Profunctor_Choice.choiceFn)(_27));
                                  })(function (arr) {
                                      return Data_Array.snoc(arr)(_4.value0);
                                  })(Data_Lens_Setter.set(function (_28) {
                                      return App_Client_State._new(Data_Profunctor_Strong.strongFn)(App_Client_State._model(Data_Profunctor_Strong.strongFn)(_28));
                                  })(init)(Data_Lens_Setter.set(function (_29) {
                                      return App_Client_State._new(Data_Profunctor_Strong.strongFn)(App_Client_State._state(Data_Profunctor_Strong.strongFn)(_29));
                      ...
                      if (_4 instanceof StartEdit) {
                          return Data_Maybe.maybe(Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit))(function (a) {
                              return OpticUI_Core.runHandler(h)(Data_Lens_Setter.set(App_Client_State._editing(Data_Profunctor_Strong.strongFn))(new Data_Maybe.Just({
                                  index: _4.value0, 
                                  previous: a, 
                                  saving: App_Model_Async.Initial.value
                              }))(s));
                          })(Data_Array["!!"](Data_Lens_Getter.view(function (_30) {
                              return App_Client_State._collection(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(App_Model_Async._Done(Data_Profunctor_Star.choiceStar(Data_Const.applicativeConst(Data_Monoid.monoidArray)))(_30));
                          })(s))(_4.value0));
                      };
                          ...
                          return Data_Maybe.maybe(Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit))(function (a) {
                              return function __do() {
                                  ...
                                  return OpticUI_Core.runHandler(h)(Data_Lens_Setter.set(function (_31) {
                                      return App_Client_State._editing(Data_Profunctor_Strong.strongFn)(Data_Lens_Prism_Maybe._Just(Data_Profunctor_Choice.choiceFn)(App_Client_State._saving(Data_Profunctor_Strong.strongFn)(_31)));
                                  })(new App_Model_Async.Busy(b))(s))();
                              };
                          })(Prelude[">>="](Data_Maybe.bindMaybe)(Data_Lens_Getter.view(App_Client_State._editing(Data_Profunctor_Star.strongStar(Data_Const.functorConst)))(s))(function (_3) {
                              return Data_Array["!!"](Data_Lens_Getter.view(function (_32) {
                                  return App_Client_State._collection(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(App_Model_Async._Done(Data_Profunctor_Star.choiceStar(Data_Const.applicativeConst(Data_Monoid.monoidArray)))(_32));
                              })(s))(_3.index);
                          }));
                      };
                      ...
                      if (_4 instanceof EditSaveFailed) {
                          return OpticUI_Core.runHandler(h)(Data_Lens_Setter.set(function (_33) {
                              return App_Client_State._editing(Data_Profunctor_Strong.strongFn)(Data_Lens_Prism_Maybe._Just(Data_Profunctor_Choice.choiceFn)(App_Client_State._saving(Data_Profunctor_Strong.strongFn)(_33)));
                          })(new App_Model_Async.Errored(_4.value0))(s));
                      };
                      throw new Error("Failed pattern match at App.Client.Views.Crud line 41, column 1 - line 49, column 1: " + [ _4.constructor.name ]);
                  };
                  return handle(comm);
              };
          };
...
})(PS["App.Client.Views.Crud"] = PS["App.Client.Views.Crud"] || {});
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var OpticUI_Core = PS["OpticUI.Core"];
  ...
  var App_Client_Types = PS["App.Client.Types"];
  var App_Client_State = PS["App.Client.State"];
  var App_Client_Components_Exec = PS["App.Client.Components.Exec"];
  var App_Endpoint = PS["App.Endpoint"];
  var Data_Generic = PS["Data.Generic"];     
      ...
      var c = function (_0) {
          return function (h) {
              if (_0 instanceof App_Model_Async.Initial) {
                  return App_Client_Components_Exec.exec(OpticUI_Markup.markupMonoid)(function __do() {
...
})(PS["App.Client.Views.Profiles"] = PS["App.Client.Views.Profiles"] || {});
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var OpticUI_Core = PS["OpticUI.Core"];
  ...
  var App_Model_Profile = PS["App.Model.Profile"];
  var App_Model_StrMap = PS["App.Model.StrMap"];
  var App_Client_Router = PS["App.Client.Router"];
  var App_Client_Types = PS["App.Client.Types"];
  var App_Client_State = PS["App.Client.State"];
  var App_Client_Components_Exec = PS["App.Client.Components.Exec"];
  var App_Client_Components_Select = PS["App.Client.Components.Select"];
  var App_Client_Views_Crud = PS["App.Client.Views.Crud"];
  var App_Client_Views_Profiles = PS["App.Client.Views.Profiles"];
  var App_Endpoint = PS["App.Endpoint"];
  var Data_Generic = PS["Data.Generic"];
  var Data_Traversable = PS["Data.Traversable"];
  var Data_Profunctor_Star = PS["Data.Profunctor.Star"];
              ...
              return function (i) {
                  if (_10 instanceof Data_Maybe.Just && i === _10.value0) {
                      return OpticUI_Core["with"](function (_5) {
                          return function (h) {
                              return OpticUI_Core.withView(OpticUI_Markup_HTML.tr([  ]))(Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ OpticUI_Core.ui(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(_5.value0.computername))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Model_Photobooth._Photobooth(OpticUI_Core.uiStrong)(App_Client_State._alias(OpticUI_Core.uiStrong)(OpticUI_Components.textField([ OpticUI_Markup_HTML.classA("form-control") ])))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Model_Photobooth._Photobooth(OpticUI_Core.uiStrong)(App_Client_State._defaultprofile(OpticUI_Core.uiStrong)(App_Client_Components_Select.select(Data_Maybe.fromMaybe([  ])(Data_StrMap.lookup(_5.value0.computername)(profiles)))(Prelude.id(Prelude.categoryFn))([ OpticUI_Markup_HTML.classA("form-control") ])))), OpticUI_Core.ui(OpticUI_Markup_HTML.td([  ])(Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Markup.markupMonoid)([ OpticUI_Markup_HTML.button([ OpticUI_Markup_HTML.classA("btn btn-warning"), OpticUI_Markup_HTML.onClick(function (_3) {
                                  return handle(new Crud(App_Client_Views_Crud.CancelEdit.value));
                                  ...
                                  return handle(new Crud(App_Client_Views_Crud.SaveEdit.value));
                  ...
                  return OpticUI_Core["with"](function (_9) {
                      return function (h) {
                          return OpticUI_Core.ui(OpticUI_Markup_HTML.tr([  ])(Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Markup.markupMonoid)([ OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(_9.value0.computername)), OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(_9.value0.alias)), OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(_9.value0.defaultprofile)), Data_Maybe.maybe(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup_HTML.button([ OpticUI_Markup_HTML.classA("btn btn-primary"), OpticUI_Markup_HTML.onClick(function (_6) {
                              return handle(Crud.create(new App_Client_Views_Crud.StartEdit(i)));
      ...
      return OpticUI_Core["with"](function ($$new) {
          return function (h) {
              return Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ App_Model_Async._Initial(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(OpticUI_Core.ui(OpticUI_Markup_HTML.button([ OpticUI_Markup_HTML.classA("btn btn-primary"), OpticUI_Markup_HTML.onClick(function (_0) {
                  return handle(new Crud(App_Client_Views_Crud.SaveNew.value));
                  ...
                  return handle(new Crud(new App_Client_Views_Crud.NewSaved(newS)));
              })(function (_33) {
                  return handle(Crud.create(App_Client_Views_Crud.NewSaveFailed.create(_33)));
  ...
  var makeNewPb = function (handle) {
      return OpticUI_Core["with"](function (model) {
          return function (h) {
              return OpticUI_Core.withView(OpticUI_Markup_HTML.tr([  ]))(Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Client_State._model(OpticUI_Core.uiStrong)(App_Client_State._computername(OpticUI_Core.uiStrong)(OpticUI_Components.textField([ OpticUI_Markup_HTML.classA("form-control") ])))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Client_State._model(OpticUI_Core.uiStrong)(App_Client_State._alias(OpticUI_Core.uiStrong)(OpticUI_Components.textField([ OpticUI_Markup_HTML.classA("form-control") ])))), OpticUI_Core.ui(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(""))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Client_State._state(OpticUI_Core.uiStrong)(makeNewPbButton(handle))) ]));
          };
      });
  };
  ...
  var listPhotobooths = function (handle) {
      return function (selInd) {
          return function (profiles) {
              return Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ App_Client_State._collection(OpticUI_Core.uiStrong)(OpticUI_Core["with"](function (pbs) {
                  return function (h) {
                      return Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ App_Model_Async._Initial(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(App_Client_Components_Exec.exec(OpticUI_Markup.markupMonoid)(handle(new Crud(App_Client_Views_Crud.LoadAll.value))))(OpticUI_Core.ui(OpticUI_Markup_HTML.tr([  ])(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text("Nothing loaded yet")))))), App_Model_Async._Busy(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ OpticUI_Core.ui(OpticUI_Markup_HTML.tr([  ])(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text("Loading photobooths")))), OpticUI_Components_Async.onResult(OpticUI_Markup.markupMonoid)(function (_34) {
                          return handle(Crud.create(App_Client_Views_Crud.Loaded.create(_34)));
                      })(function (_35) {
                          return handle(Crud.create(App_Client_Views_Crud.LoadingFailed.create(_35)));
              ...
              })), App_Client_State._editing(OpticUI_Core.uiStrong)(Data_Lens_Prism_Maybe._Just(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(App_Client_State._saving(OpticUI_Core.uiStrong)(App_Model_Async._Busy(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(OpticUI_Components_Async.onResult(OpticUI_Markup.markupMonoid)(function (edited) {
                  return handle(new Crud(new App_Client_Views_Crud.EditSaved(edited)));
              })(function (_36) {
                  return handle(Crud.create(App_Client_Views_Crud.EditSaveFailed.create(_36)));
              }))))), App_Client_State._editing(OpticUI_Core.uiStrong)(Data_Lens_Prism_Maybe._Just(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(App_Client_State._saving(OpticUI_Core.uiStrong)(App_Model_Async._Errored(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(OpticUI_Core["with"](function (err) {
                  return function (h) {
          ...
          return function (h) {
              ...
              var handle = function (_11) {
                  if (_11 instanceof Crud) {
                      return App_Client_Views_Crud.crudHandler(s)(h)(impls)(_11.value0);
                  };
                  if (_11 instanceof ToEvents) {
                      return $$goto(new App_Client_State.EventsPage(_11.value0));
                  };
                  if (_11 instanceof ToStatistics) {
                      return $$goto(new App_Client_State.StatisticsPage(_11.value0));
                  };
                  throw new Error("Failed pattern match at App.Client.Views.PhotoboothsPage line 48, column 1 - line 55, column 1: " + [ _11.constructor.name ]);
              };
              ...
              })(Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ OpticUI_Core.ui(OpticUI_Markup_HTML.tr([  ])(Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Markup.markupMonoid)([ OpticUI_Markup_HTML.th([  ])(OpticUI_Markup.text("Name")), OpticUI_Markup_HTML.th([  ])(OpticUI_Markup.text("Alias")), OpticUI_Markup_HTML.th([  ])(OpticUI_Markup.text("Default Profile")), OpticUI_Markup_HTML.th([  ])(OpticUI_Markup.text("Actions")), OpticUI_Markup_HTML.th([  ])(OpticUI_Markup.text("Link")) ]))), App_Client_State._collectionEditing(OpticUI_Core.uiStrong)(listPhotobooths(handle)(Prelude[">>="](Data_Maybe.bindMaybe)(Data_Lens_Getter.view(App_Client_State._editing(Data_Profunctor_Star.strongStar(Data_Const.functorConst)))(s))(function (ed) {
                  return Prelude["return"](Data_Maybe.applicativeMaybe)(ed.index);
              }))(Data_Lens_Getter.view(function (_38) {
                  return App_Client_State._profiles(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(App_Model_Async._Done(Data_Profunctor_Star.choiceStar(Data_Const.applicativeConst(Data_StrMap.monoidStrMap(Prelude.semigroupArray))))(_38));
              })(s))), App_Client_State._new(OpticUI_Core.uiStrong)(makeNewPb(handle)), App_Client_State._profiles(OpticUI_Core.uiStrong)(App_Client_Views_Profiles.loadProfiles) ]));
          };
      });
  };
  exports["photoboothsPage"] = photoboothsPage;;
 
})(PS["App.Client.Views.PhotoboothsPage"] = PS["App.Client.Views.PhotoboothsPage"] || {});
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var Data_Lens_Internal_Wander = PS["Data.Lens.Internal.Wander"];
...
})(PS["App.Client.Components.FileInput"] = PS["App.Client.Components.FileInput"] || {});
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var $foreign = PS["App.Client.Components.FileInput"];
  var OpticUI_Core = PS["OpticUI.Core"];
  var Prelude = PS["Prelude"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var OpticUI = PS["OpticUI"];
      ...
      return OpticUI_Core["with"](function (s) {
          return function (h) {
              var props = Prelude["<>"](Prelude.semigroupArray)([ OpticUI_Markup_HTML.typeA("file"), onFileInput(function (_0) {
                  ...
                  throw new Error("Failed pattern match at App.Client.Components.FileInput line 31, column 7 - line 33, column 4: " + [ _2.constructor.name ]);
              })());
...
})(PS["App.Client.Components.DateTimeField"] = PS["App.Client.Components.DateTimeField"] || {});
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var OpticUI_Core = PS["OpticUI.Core"];
  ...
  var App_Client_State = PS["App.Client.State"];
  var App_Client_Components_Exec = PS["App.Client.Components.Exec"];
  var App_Client_Components_FileInput = PS["App.Client.Components.FileInput"];
  var App_Client_Components_Select = PS["App.Client.Components.Select"];
  var App_Client_Components_DateTimeField = PS["App.Client.Components.DateTimeField"];
  var App_Client_Views_Crud = PS["App.Client.Views.Crud"];
  var App_Client_Views_Profiles = PS["App.Client.Views.Profiles"];
  var App_Endpoint = PS["App.Endpoint"];
  var App_Client_Load = PS["App.Client.Load"];
  ...
  var saveUpdatedEvent = function (i) {
      return Prelude[">>="](Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint(App_Model_Event.genericEvent)(App_Model_Event.genericEvent)(App_Endpoint.putEvents)(Prelude.unit)(Data_Lens_Getter.view(App_Client_State._model(Data_Profunctor_Star.strongStar(Data_Const.functorConst)))(i)))(function (n) {
  ...
  var saveNewEvent = function (i) {
      return Prelude[">>="](Control_Monad_Aff.bindAff)(Endpoint_Client.execEndpoint(App_Model_Event.genericEvent)(App_Model_Event.genericEvent)(App_Endpoint.postEvents)(Prelude.unit)(Data_Lens_Getter.view(App_Client_State._model(Data_Profunctor_Star.strongStar(Data_Const.functorConst)))(i)))(function (n) {
          return Prelude["return"](Control_Monad_Aff.applicativeAff)((function () {
              var _18 = {};
              for (var _19 in i) {
  ...
  var saveFile = function (file) {
      return function (i) {
          return Endpoint_Client.sendJpeg(App_Model_SavedImage.genericSavedImage)(App_Endpoint.attachImage)(file)(new Data_Tuple.Tuple(i, App_Client_Components_FileInput.name(file)));
      };
  };
          ...
          return function (h) {
              if (_15 instanceof App_Model_Async.Busy) {
                  return Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(OpticUI_Core.ui(OpticUI_Markup_HTML.button([ OpticUI_Markup_HTML.classA("btn btn-warning") ])(OpticUI_Markup.text("Saving Event"))))(App_Model_Async._Busy(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(OpticUI_Components_Async.onResult(OpticUI_Markup.markupMonoid)(function (_79) {
                      return handle(Crud.create(App_Client_Views_Crud.NewSaved.create(_79)));
                  })(function (_80) {
                      return handle(Crud.create(App_Client_Views_Crud.NewSaveFailed.create(_80)));
                  })));
              };
  ...
  var makeNewEvent = function (handle) {
      return OpticUI_Core["with"](function (s) {
          return function (h) {
              return OpticUI_Core.withView(OpticUI_Markup_HTML.tr([  ]))(Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ OpticUI_Core.ui(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(""))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Client_State._model(OpticUI_Core.uiStrong)(App_Client_State._computername(OpticUI_Core.uiStrong)(OpticUI_Components.textField([ OpticUI_Markup_HTML.classA("form-control") ])))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Client_State._model(OpticUI_Core.uiStrong)(App_Client_State._name(OpticUI_Core.uiStrong)(OpticUI_Components.textField([ OpticUI_Markup_HTML.classA("form-control") ])))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Client_State._model(OpticUI_Core.uiStrong)(App_Client_State._datefrom(OpticUI_Core.uiStrong)(App_Client_Components_DateTimeField.dateTimeField([ OpticUI_Markup_HTML.classA("form-control") ])))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Client_State._model(OpticUI_Core.uiStrong)(App_Client_State._dateuntil(OpticUI_Core.uiStrong)(App_Client_Components_DateTimeField.dateTimeField([ OpticUI_Markup_HTML.classA("form-control") ])))), OpticUI_Core.ui(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(""))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Client_State._state(OpticUI_Core.uiStrong)(newEventButton(handle))), OpticUI_Core.ui(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(""))) ]));
          };
      });
  };
          ...
          return function (editing) {
              var c = function (_14) {
                  if (_14 instanceof Data_Maybe.Nothing) {
                      return OpticUI_Core.ui(OpticUI_Markup_HTML.button([ OpticUI_Markup_HTML.classA("btn btn-primary"), OpticUI_Markup_HTML.onClick(Prelude["const"](handle(Crud.create(new App_Client_Views_Crud.StartEdit(i))))) ])(OpticUI_Markup.text("Edit!")));
                  };
                  ...
                  throw new Error("Failed pattern match at App.Client.Views.EventsPage line 126, column 5 - line 127, column 5: " + [ _14.constructor.name ]);
              };
              return c(editing);
          };
      };
                      ...
                      return function (_11) {
                          return function (h) {
                              if (_10 instanceof Data_Maybe.Just && _10.value0 === i) {
                                  return Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ OpticUI_Core.ui(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(Data_Maybe.maybe("")(Prelude.show(Prelude.showInt))(_11.model.value0.id)))), OpticUI_Core.ui(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(_11.model.value0.computername))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Client_State._model(OpticUI_Core.uiStrong)(App_Model_Event._Event(OpticUI_Core.uiStrong)(App_Client_State._name(OpticUI_Core.uiStrong)(OpticUI_Components.textField([ OpticUI_Markup_HTML.classA("form-control") ]))))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Client_State._model(OpticUI_Core.uiStrong)(App_Model_Event._Event(OpticUI_Core.uiStrong)(App_Client_State._datefrom(OpticUI_Core.uiStrong)(App_Client_Components_DateTimeField.dateTimeField([ OpticUI_Markup_HTML.classA("form-control") ]))))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Client_State._model(OpticUI_Core.uiStrong)(App_Model_Event._Event(OpticUI_Core.uiStrong)(App_Client_State._dateuntil(OpticUI_Core.uiStrong)(App_Client_Components_DateTimeField.dateTimeField([ OpticUI_Markup_HTML.classA("form-control") ]))))), OpticUI_Core.withView(OpticUI_Markup_HTML.td([  ]))(App_Client_State._model(OpticUI_Core.uiStrong)(App_Model_Event._Event(OpticUI_Core.uiStrong)(App_Client_State._profile(OpticUI_Core.uiStrong)(App_Client_Components_Select.select(Data_Maybe.fromMaybe([  ])(Data_StrMap.lookup(_11.model.value0.computername)(profiles)))(Prelude.id(Prelude.categoryFn))([ OpticUI_Markup_HTML.classA("form-control") ]))))), editEventButton(handle)(i)(editing), OpticUI_Core.ui(OpticUI_Markup_HTML.td([  ])(OpticUI_Markup.text(""))) ]);
                              };
                              var fileSelected = function (_12) {
                                  return function (_13) {
                                      ...
                                      throw new Error("Failed pattern match at App.Client.Views.EventsPage line 107, column 11 - line 108, column 8: " + [ _12.constructor.name, _13.constructor.name ]);
                                  };
                              };
                              var fileSaved = function (si) {
                                  return OpticUI_Core.runHandler(h)({
                                      model: Data_Lens_Setter.over(function (_81) {
                                          return App_Model_Event._Event(Data_Profunctor_Strong.strongFn)(App_Client_State._images(Data_Profunctor_Strong.strongFn)(_81));
                              ...
                              }))))), App_Client_State._state(OpticUI_Core.uiStrong)(App_Client_State._savingImage(OpticUI_Core.uiStrong)(App_Model_Async._Errored(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(OpticUI_Core["with"](function (err) {
                                  return function (_2) {
                              ...
                              })))) ])), App_Client_State._state(OpticUI_Core.uiStrong)(App_Client_State._savingImage(OpticUI_Core.uiStrong)(App_Model_Async._Busy(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(OpticUI_Components_Async.onResult(OpticUI_Markup.markupMonoid)(fileSaved)(fileSaveErrored)))) ]);
                          };
                      };
                  };
              };
          ...
          var c = function (_9) {
              return function (h) {
                  ...
                  if (_9.collection instanceof App_Model_Async.Done) {
                      ...
                      var editing = Data_Lens_Getter.view(App_Client_State._editing(Data_Profunctor_Star.strongStar(Data_Const.functorConst)))(_9);
                      return App_Client_State._collection(OpticUI_Core.uiStrong)(App_Model_Async._Done(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(OpticUI_Core.foreach(OpticUI_Markup.markupMonoid)(Data_Traversable.traversableArray)(function (i) {
                          return OpticUI_Core.withView(OpticUI_Markup_HTML.tr([  ]))(OpticUI_Core["with"](line(selI)(editing)(i)));
                      })));
                  };
                  throw new Error("Failed pattern match at App.Client.Views.EventsPage line 76, column 1 - line 81, column 1: " + [ _9.constructor.name, h.constructor.name ]);
              };
          };
          return Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(OpticUI_Core["with"](c))(Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(App_Client_State._collection(OpticUI_Core.uiStrong)(App_Model_Async._Initial(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(App_Client_Components_Exec.exec(OpticUI_Markup.markupMonoid)(handle(new Crud(App_Client_Views_Crud.LoadAll.value))))))(Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(App_Client_State._collection(OpticUI_Core.uiStrong)(App_Model_Async._Busy(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(OpticUI_Components_Async.onResult(OpticUI_Markup.markupMonoid)(function (_82) {
              return handle(Crud.create(App_Client_Views_Crud.Loaded.create(_82)));
          })(function (_83) {
              return handle(Crud.create(App_Client_Views_Crud.LoadingFailed.create(_83)));
          }))))(App_Client_State._editing(OpticUI_Core.uiStrong)(Data_Lens_Prism_Maybe._Just(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(App_Client_State._saving(OpticUI_Core.uiStrong)(App_Model_Async._Busy(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(OpticUI_Components_Async.onResult(OpticUI_Markup.markupMonoid)(function (_84) {
              return handle(Crud.create(App_Client_Views_Crud.EditSaved.create(_84)));
          })(function (_85) {
              return handle(Crud.create(App_Client_Views_Crud.EditSaveFailed.create(_85)));
          }))))))));
      };
  };
  var eventsPage = function (cn) {
      var c = function (s) {
          return function (h) {
              var impls = {
                  loadAll: App_Client_Load.loadEvents(cn), 
              ...
              var handle = function (_8) {
                  return App_Client_Views_Crud.crudHandler(s)(h)(impls)(_8.value0);
              };
              ...
              })(Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(App_Client_State._collectionEditing(OpticUI_Core.uiStrong)(showEvents(handle)(Data_Lens_Getter.view(function (_87) {
                  return App_Client_State._profiles(Data_Profunctor_Star.strongStar(Data_Const.functorConst))(App_Model_Async._Done(Data_Profunctor_Star.choiceStar(Data_Const.applicativeConst(Data_StrMap.monoidStrMap(Prelude.semigroupArray))))(_87));
              })(s))))(App_Client_State._new(OpticUI_Core.uiStrong)(makeNewEvent(handle)))), App_Client_State._profiles(OpticUI_Core.uiStrong)(App_Client_Views_Profiles.loadProfiles) ]));
          };
      };
      return OpticUI_Core["with"](c);
  };
...
})(PS["App.Client.Views.EventsPage"] = PS["App.Client.Views.EventsPage"] || {});
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var OpticUI_Core = PS["OpticUI.Core"];
  ...
  var eventStatisticsLine = function (events) {
      return function (_4) {
          return OpticUI_Markup_HTML.tr([  ])((function () {
              ...
              throw new Error("Failed pattern match at App.Client.Views.StatisticsPage line 66, column 1 - line 67, column 1: " + [ _14.constructor.name ]);
          })());
      };
  };
  var statisticsPage = function (cn) {
      ...
      return OpticUI_Core["with"](function (s) {
          return function (h) {
              return Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ App_Client_State._statistics(OpticUI_Core.uiStrong)(App_Model_Async._Busy(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(OpticUI_Components_Async.onResult(OpticUI_Markup.markupMonoid)(function (a) {
                  return OpticUI_Core.runHandler(h)(Data_Lens_Setter.set(App_Client_State._statistics(Data_Profunctor_Strong.strongFn))(new App_Model_Async.Done(a))(s));
              })(function (err) {
                  return OpticUI_Core.runHandler(h)(Data_Lens_Setter.set(App_Client_State._statistics(Data_Profunctor_Strong.strongFn))(new App_Model_Async.Errored(err))(s));
              }))(OpticUI_Core.ui(OpticUI_Markup_HTML.div([  ])(OpticUI_Markup.text("Loading statistics")))))), App_Client_State._statistics(OpticUI_Core.uiStrong)(App_Model_Async._Errored(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(OpticUI_Core["with"](function (err) {
                  return function (_0) {
              ...
              }))), App_Client_State._events(OpticUI_Core.uiStrong)(App_Model_Async._Busy(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(OpticUI_Components_Async.onResult(OpticUI_Markup.markupMonoid)(function (a) {
                  return OpticUI_Core.runHandler(h)(Data_Lens_Setter.set(App_Client_State._events(Data_Profunctor_Strong.strongFn))(new App_Model_Async.Done(a))(s));
              })(function (err) {
                  return OpticUI_Core.runHandler(h)(Data_Lens_Setter.set(App_Client_State._events(Data_Profunctor_Strong.strongFn))(new App_Model_Async.Errored(err))(s));
              }))(OpticUI_Core.ui(OpticUI_Markup_HTML.div([  ])(OpticUI_Markup.text("Loading events")))))), App_Client_State._events(OpticUI_Core.uiStrong)(App_Model_Async._Errored(OpticUI_Core.uiChoice(OpticUI_Markup.markupMonoid))(OpticUI_Core["with"](function (err) {
                  return function (_1) {
...
})(PS["App.Client.Views.StatisticsPage"] = PS["App.Client.Views.StatisticsPage"] || {});
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  ...
  var Data_Lens = PS["Data.Lens"];
  var Data_Tuple = PS["Data.Tuple"];
  var App_Client_Views_PhotoboothsPage = PS["App.Client.Views.PhotoboothsPage"];
  var App_Client_Views_EventsPage = PS["App.Client.Views.EventsPage"];
  var App_Client_Views_StatisticsPage = PS["App.Client.Views.StatisticsPage"];
  var App_Client_Router = PS["App.Client.Router"];
  var App_Client_Types = PS["App.Client.Types"];
  var App_Client_State = PS["App.Client.State"];
  var Data_Profunctor_Star = PS["Data.Profunctor.Star"];
  ...
  var main = function __do() {
      var _3 = App_Client_State.initialState(App_Client_State.PhotoboothsPage.value)();
      var _2 = Prelude["<$>"](Control_Monad_Eff.functorEff)(App_Client_Router.match)(App_Client_Router.getHash)();
      var _1 = App_Client_Router.nav_(_3)(_2)();
      var _0 = OpticUI_Run.animate(_1.value1)(OpticUI_Core["with"](function (s) {
          return function (h) {
              var nav$prime = App_Client_Router.nav(s)(h);
              var _8 = Data_Lens_Getter.view(App_Client_State._route(Data_Profunctor_Star.strongStar(Data_Const.functorConst)))(s);
              if (_8 instanceof App_Client_State.PhotoboothsPage) {
                  return App_Client_State._pbPage(OpticUI_Core.uiStrong)(App_Client_Views_PhotoboothsPage.photoboothsPage(nav$prime));
              };
              if (_8 instanceof App_Client_State.EventsPage) {
                  return App_Client_State._eventsPage(OpticUI_Core.uiStrong)(App_Client_Views_EventsPage.eventsPage(_8.value0));
              };
              if (_8 instanceof App_Client_State.StatisticsPage) {
                  return App_Client_State._statisticsPage(OpticUI_Core.uiStrong)(App_Client_Views_StatisticsPage.statisticsPage(_8.value0));
              };
              throw new Error("Failed pattern match at App.Client line 20, column 1 - line 21, column 1: " + [ _8.constructor.name ]);
          };
      }))();
      return App_Client_Router.hashChanged(function (str) {
          return _0(function (s) {
              return function __do() {
                  var _4 = App_Client_Router.nav_(s)(App_Client_Router.match(str))();
