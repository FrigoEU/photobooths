      ...
      return OpticUI_Core["with"](function (s) {
          return function (h) {
              ...
              var handle = function (_11) {
                  ...
                  throw new Error("Failed pattern match at App.GUI.Views.PhotoboothsPage line 44, column 1 - line 51, column 1: " + [ _11.constructor.name ]);
              };
              return Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(OpticUI_Core.ui(OpticUI_Markup_HTML.h1([ OpticUI_Markup_HTML.classA("page-title") ])(OpticUI_Markup.text("Photobooths"))))(OpticUI_Core.withView(function (_37) {
                  return OpticUI_Markup_HTML.div([ OpticUI_Markup_HTML.classA("crud-table-wrapper") ])(OpticUI_Markup_HTML.table([ OpticUI_Markup_HTML.classA("table crud-table") ])(OpticUI_Markup_HTML.tbody([  ])(_37)));
...
(function(exports) {
  ...
  var showEvents = function (handle) {
      return function (profiles) {
          var listFiles = App_GUI_State._model(OpticUI_Core.uiStrong)(App_Model_Event._Event(OpticUI_Core.uiStrong)(App_GUI_State._files(OpticUI_Core.uiStrong)(OpticUI_Core.traversal(OpticUI_Markup.markupMonoid)(function (__dict_Wander_0) {
  ...
  var eventsPage = function (cn) {
      var c = function (s) {
          return function (h) {
              ...
              return Data_Foldable.mconcat(Data_Foldable.foldableArray)(OpticUI_Core.uiMonoid(OpticUI_Markup.markupMonoid))([ OpticUI_Core.ui(OpticUI_Markup_HTML.h1([ OpticUI_Markup_HTML.classA("page-title") ])(OpticUI_Markup.text("Events for: " + cn))), OpticUI_Core.withView(function (_86) {
...
(function(exports) {
  ...
  var statisticsPage = function (cn) {
      ...
      return Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(OpticUI_Core.ui(OpticUI_Markup_HTML.h1([ OpticUI_Markup_HTML.classA("page-title") ])(OpticUI_Markup.text("Statistics for: " + cn))))(Prelude["<>"](OpticUI_Core.uiSemigroup(OpticUI_Markup.markupSemigroup))(OpticUI_Core["with"](function (s) {
          return function (h) {
