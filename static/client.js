      ...
      return function (xs) {
          var comp$prime = function (x) {
              return function (y) {
                  ...
                  throw new Error("Failed pattern match at Data.Array line 409, column 15 - line 414, column 1: " + [ $46.constructor.name ]);
              };
          };
...
(function(exports) {
  ...
  var fromJSDate = function (d) {
      ...
      throw new Error("Failed pattern match at Data.Date line 60, column 3 - line 65, column 1: " + [ $44.constructor.name ]);
  };
...
(function(exports) {
          ...
          var go = function (v1) {
              return function (v2) {
                  ...
                  if (v1 instanceof Data_Generic.SigProd && v2 instanceof Data_Generic.SProd) {
                      ...
                      throw new Error("Failed pattern match at Data.Foreign.Generic line 129, column 9 - line 141, column 3: " + [ $66.constructor.name ]);
                  };
  ...
  var toJSONGeneric = function (dictGeneric) {
      return function (opts) {
          return function ($138) {
              return Global_Unsafe.unsafeStringify(toForeignGeneric(dictGeneric)(opts)($138));
          };
      };
  };
  var readGeneric = function (dictGeneric) {
      return function (v) {
          var go = function (v1) {
              return function (f) {
                  ...
                  if (v1 instanceof Data_Generic.SigProd && (v1.value0 === "Data.Maybe.Maybe" && (v1.value1.length === 2 && ((v1.value1[0]).sigValues.length === 1 && v.maybeAsNull)))) {
                      ...
                      throw new Error("Failed pattern match at Data.Foreign.Generic line 84, column 5 - line 88, column 3: " + [ $101.constructor.name ]);
                  };
                  if (v1 instanceof Data_Generic.SigProd) {
                      return Prelude.bind(Data_Either.bindEither)(Prelude[">>="](Data_Either.bindEither)(Data_Foreign_Index.prop(v.sumEncoding.value0.tagFieldName)(f))(Data_Foreign.readString))(function (v2) {
                          ...
                          throw new Error("Failed pattern match at Data.Foreign.Generic line 92, column 9 - line 105, column 1: " + [ $112.constructor.name ]);
                      });
                  };
                  throw new Error("Failed pattern match at Data.Foreign.Generic line 63, column 3 - line 64, column 3: " + [ v1.constructor.name, f.constructor.name ]);
              };
          };
          var fromSpineUnsafe = function (sp) {
              ...
              throw new Error("Failed pattern match at Data.Foreign.Generic line 58, column 5 - line 62, column 3: " + [ $130.constructor.name ]);
          };
          return function ($139) {
              return Prelude.map(Data_Either.functorEither)(fromSpineUnsafe)(go(Data_Generic.toSignature(dictGeneric)((Type_Proxy["Proxy"]).value))($139));
          };
      };
  };
...
(function(exports) {
  ...
  var serializableUnit = new Serializable(function (s) {
      ...
      throw new Error("Failed pattern match at Data.Serializable line 76, column 19 - line 79, column 1: " + [ $7.constructor.name ]);
  }, function (s) {
      return "unit";
  });
...
(function(exports) {
  ...
  var responseTypeToString = function (v) {
      ...
      throw new Error("Failed pattern match at Network.HTTP.Affjax.Response line 58, column 1 - line 59, column 1: " + [ v.constructor.name ]);
  };
              ...
              return function (eb) {
                  return function (cb) {
                      ...
                      var requestSettings = (function () {
                          ...
                          throw new Error("Failed pattern match at Network.HTTP.Affjax line 223, column 21 - line 227, column 3: " + [ $51.constructor.name ]);
                      })();
                      var cb$prime = function (res) {
                          ...
                          throw new Error("Failed pattern match at Network.HTTP.Affjax line 242, column 13 - line 246, column 1: " + [ $57.constructor.name ]);
                      };
          ...
          return function (v) {
              return function (file) {
                  return function (a) {
                      ...
                      return Prelude[">>="](Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableBlob)(Network_HTTP_Affjax_Response.responsableString)(opts))(function ($25) {
                  ...
                  return function (v) {
                      return function (a) {
                          return function (b) {
                              ...
                              return Prelude[">>="](Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableString)(Network_HTTP_Affjax_Response.responsableString)(opts))(function ($26) {
...
(function(exports) {
  ...
  var genericRoute = new Data_Generic.Generic(function (v) {
      ...
      throw new Error("Failed pattern match at App.GUI.State line 79, column 1 - line 83, column 1: " + [ v.constructor.name ]);
  });
  ...
  var _pbPage = function (dictStrong) {
      return Data_Lens_Lens.lens(function (obj) {
          ...
          return function (obj) {
              var $190 = {};
              for (var $191 in old) {
                  if (old.hasOwnProperty($191)) {
                      $190[$191] = old[$191];
                  };
              };
              $190.photobooths = obj.collection;
              $190.profiles = obj.profiles;
              $190.photoboothsPage = {
                  "new": obj["new"], 
                  editing: obj.editing, 
  ...
  var _eventsPage = function (dictStrong) {
      return Data_Lens_Lens.lens(function (obj) {
          ...
          return function (obj) {
              var $210 = {};
              for (var $211 in old) {
                  if (old.hasOwnProperty($211)) {
                      $210[$211] = old[$211];
                  };
              };
              $210.profiles = obj.profiles;
              $210.eventsPage = {
                  "new": obj["new"], 
                  editing: obj.editing, 
                  deleting: obj.deleting, 
  ...
  var _collectionEditing = Data_Lens_Lens.lens(function (v) {
      ...
      return function (v) {
          var $244 = {};
          for (var $245 in old) {
              if (old.hasOwnProperty($245)) {
                  $244[$245] = old[$245];
              };
          };
          $244.collection = v.collection;
          $244.editing = v.editing;
          return $244;
      };
  });
...
(function(exports) {
  ...
  var resolve = function (s) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at App.GUI.Router line 43, column 1 - line 44, column 1: " + [ s.constructor.name, v.constructor.name ]);
      };
  };
  var nav = function (s) {
      return function (h) {
  ...
  var main = function __do() {
      ...
      var v3 = OpticUI_Run.animate(newSWithRoute)(OpticUI_Core["with"](function (s) {
          return function (h) {
              ...
              throw new Error("Failed pattern match at App.GUI line 28, column 9 - line 32, column 3: " + [ $8.constructor.name ]);
          };
      }))();
